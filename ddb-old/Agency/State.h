...
class State {
 public:
  ...
  std::vector<index_t> logLeaderMulti(darbotdb::velocypack::Slice query,
                                      std::vector<apply_ret_t> const& indices,
                                      term_t term);

  /// @brief Single log entry (leader)
  index_t logLeaderSingle(darbotdb::velocypack::Slice slice, term_t term,
                          std::string const& clientId = std::string());

  /// @brief Log entries (followers)
  darbotdb::consensus::index_t logFollower(
 ...
 private:
  ...
  static index_t extractIndexFromKey(darbotdb::velocypack::Slice data);
 ...
 public:
  ...
  ///        Default: [first, last]
  darbotdb::velocypack::Builder slices(
      index_t = 0, index_t = (std::numeric_limits<uint64_t>::max)()) const;
  ...
  bool compact(darbotdb::consensus::index_t cind,
               darbotdb::consensus::index_t keep);
 ...
 private:
  ...
  size_t removeConflicts(darbotdb::velocypack::Slice transactions,
                         bool gotSnapshot);
 ...
 private:
  ...
  bool persistCompactionSnapshot(darbotdb::consensus::index_t cind,
  ...
  bool storeLogFromSnapshot(darbotdb::consensus::Store& snapshot,
                            darbotdb::consensus::index_t index,
                            darbotdb::consensus::term_t term);
  ...
  bool compactPersisted(darbotdb::consensus::index_t cind,
                        darbotdb::consensus::index_t keep);

  /// @brief Compact RAM logs
  bool compactVolatile(darbotdb::consensus::index_t cind,
                       darbotdb::consensus::index_t keep);

  /// @brief Remove obsolete logs
  bool removeObsolete(darbotdb::consensus::index_t cind);
  ...
  */
  ...
  std::multimap<std::string, darbotdb::consensus::index_t> _clientIdLookupTable;
  ...
  darbotdb::OperationOptions _options;
