...
class Supervision : public ServerThread<ddbServer> {
 public:
  typedef std::chrono::system_clock::time_point TimePoint;
  typedef std::string ServerID;

  /// @brief Construct cluster consistency checking
  Supervision(ddbServer& server, metrics::MetricsFeature& metrics);
 ...
 private:
  ...
  darbotdb::basics::ConditionVariable _cv; /**< @brief Control if thread
                                              should run */
