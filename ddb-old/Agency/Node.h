...
namespace darbotdb::cluster::paths {
class Path;
}
...
class Node : public std::enable_shared_from_this<Node> {
 ...
 private:
  ...
  using AccountingMemoryPolicy = ::immer::memory_policy<
      AccountingHeap<darbotdb::immer::DDB_heap_policy>,
 ...
 public:
  ...
  bool operator==(darbotdb::velocypack::Slice const&) const;
  ...
  [[nodiscard]] static darbotdb::ResultT<NodePtr> handle(
      Node const* target, darbotdb::velocypack::Slice const&);
