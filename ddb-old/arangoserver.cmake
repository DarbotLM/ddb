...
if (USE_V8) 
  target_sources(ddbserver PRIVATE
...
target_link_libraries(ddbserver
  ddb_agency
  ddb_aql
  ddb_cluster_engine
  ddb_cluster_methods
  ddb_common_rest_handler
  ddb_futures
  ddb_geo
  ddb_graph
  ddb_indexes
  ...
  ${MSVC_LIBS})
if (MSVC)
  target_link_libraries(ddbserver Bcrypt.lib)
endif()

if (USE_V8)
  target_link_libraries(ddbserver ddb_v8server)
endif()

target_include_directories(ddbserver PRIVATE
  "${PROJECT_SOURCE_DIR}/ddb"
  "${PROJECT_SOURCE_DIR}/${ENTERPRISE_INCLUDE_DIR}")

add_dependencies(ddbserver tzdata)
