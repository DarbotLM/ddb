...
class ClusterEngine final : public StorageEngine {
 public:
  ...
  ErrorCode saveReplicationApplierConfiguration(
      darbotdb::velocypack::Slice slice, bool doSync) override {
    return TRI_ERROR_NOT_IMPLEMENTED;
  }
  ...
  virtual std::unique_ptr<TRI_vocbase_t> openDatabase(
      darbotdb::CreateDatabaseInfo&& info, bool isUpgrade) override;
  ...
  darbotdb::Result compactAll(bool changeLevel,
  ...
  void addParametersForNewCollection(darbotdb::velocypack::Builder& builder,
