...
// by means of the optimizer rule `darbotdb::aql::geoIndexRule` which can
...
// direction, which can be darbotdb::geo_index::DocumentsAscending
...
std::unique_ptr<IndexIterator> RocksDBGeoIndex::iteratorForCondition(
    ...
    darbotdb::aql::Variable const* reference, IndexIteratorOptions const& opts,
...
darbotdb::Index::FilterCosts RocksDBGeoIndex::supportsFilterCondition(
    transaction::Methods& /*trx*/,
    std::vector<std::shared_ptr<darbotdb::Index>> const& allIndexes,
    aql::AstNode const* node, aql::Variable const* reference,
    size_t itemsInIndex) const {
  darbotdb::Index::FilterCosts costs =
      darbotdb::Index::FilterCosts::defaultCosts(itemsInIndex, 1);
