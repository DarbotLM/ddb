...
class RocksDBFulltextIndex final : public RocksDBIndex {
 public:
  ...
  darbotdb::Result parseQueryString(std::string const&, FulltextQuery&);
 ...
 private:
  std::set<std::string> wordlist(darbotdb::velocypack::Slice const&);
  ...
  darbotdb::Result applyQueryToken(transaction::Methods* trx,
