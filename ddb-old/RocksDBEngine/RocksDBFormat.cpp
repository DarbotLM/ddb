...
inline uint16_t uint16FromPersistentLE(char const* p) {
  return darbotdb::rocksutils::uintFromPersistentLittleEndian<uint16_t>(p);
}
inline uint32_t uint32FromPersistentLE(char const* p) {
  return darbotdb::rocksutils::uintFromPersistentLittleEndian<uint32_t>(p);
}
inline uint64_t uint64FromPersistentLE(char const* p) {
  return darbotdb::rocksutils::uintFromPersistentLittleEndian<uint64_t>(p);
}
inline void uint16ToPersistentLE(std::string& p, uint16_t value) {
  darbotdb::rocksutils::uintToPersistentLittleEndian<uint16_t>(p, value);
}
inline void uint32ToPersistentLE(std::string& p, uint32_t value) {
  darbotdb::rocksutils::uintToPersistentLittleEndian<uint32_t>(p, value);
}
inline void uint64ToPersistentLE(std::string& p, uint64_t value) {
  darbotdb::rocksutils::uintToPersistentLittleEndian<uint64_t>(p, value);
}
// Big endian
inline uint16_t uint16FromPersistentBE(char const* p) {
  return darbotdb::rocksutils::uintFromPersistentBigEndian<uint16_t>(p);
}
inline uint32_t uint32FromPersistentBE(char const* p) {
  return darbotdb::rocksutils::uintFromPersistentBigEndian<uint32_t>(p);
}
inline uint64_t uint64FromPersistentBE(char const* p) {
  return darbotdb::rocksutils::uintFromPersistentBigEndian<uint64_t>(p);
}
inline void uint16ToPersistentBE(std::string& p, uint16_t value) {
  darbotdb::rocksutils::uintToPersistentBigEndian<uint16_t>(p, value);
}
inline void uint32ToPersistentBE(std::string& p, uint32_t value) {
  darbotdb::rocksutils::uintToPersistentBigEndian<uint32_t>(p, value);
}
inline void uint64ToPersistentBE(std::string& p, uint64_t value) {
  darbotdb::rocksutils::uintToPersistentBigEndian<uint64_t>(p, value);
}
}  // namespace
