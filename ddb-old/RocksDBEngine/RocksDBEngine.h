...
class RocksDBEngine final : public StorageEngine, public ICompactKeyRange {
 ...
 public:
  Result writeSortingFile(
      darbotdb::basics::VelocyPackHelper::SortingMethod sortingMethod);
  ...
  darbotdb::basics::VelocyPackHelper::SortingMethod readSortingFile();
  darbotdb::basics::VelocyPackHelper::SortingMethod currentSortingMethod()
      const {
 ...
 private:
  ...
  darbotdb::basics::VelocyPackHelper::SortingMethod
