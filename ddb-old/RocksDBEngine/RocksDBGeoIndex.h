...
class RocksDBGeoIndex final : public RocksDBIndex, public geo_index::Index {
 public:
  ...
  RocksDBGeoIndex(IndexId iid, darbotdb::LogicalCollection& collection,
  ...
  coveredFields() const override {
    ...
    return darbotdb::Index::emptyCoveredFields;
  }
  ...
  darbotdb::Index::FilterCosts supportsFilterCondition(
  ...
  void toVelocyPack(
      velocypack::Builder&,
      std::underlying_type<darbotdb::Index::Serialize>::type) const override;
