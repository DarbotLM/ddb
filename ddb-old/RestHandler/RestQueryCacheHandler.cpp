...
RestQueryCacheHandler::RestQueryCacheHandler(ddbServer& server,
...
void RestQueryCacheHandler::clearCache() {
  auto queryCache = darbotdb::aql::QueryCache::instance();
...
void RestQueryCacheHandler::replaceProperties() {
  ...
  darbotdb::aql::QueryCache::instance()->properties(body);
  readProperties();
}
