...
static void addVersionDetails(ddbServer& server, VPackBuilder& result) {
...
////////////////////////////////////////////////////////////////////////////////
/// @brief darbotdb server
////////////////////////////////////////////////////////////////////////////////

RestVersionHandler::RestVersionHandler(ddbServer& server,
                                       GeneralRequest* request,
                                       GeneralResponse* response)
    : RestBaseHandler(server, request, response) {}

void RestVersionHandler::getVersion(ddbServer& server, bool allowInfo,
  ...
  if (allowInfo) {
    result.add("version", VPackValue(darbotdb_VERSION));
