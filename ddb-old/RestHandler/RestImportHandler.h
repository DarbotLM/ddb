...
class RestImportHandler : public RestVocbaseBaseHandler {
 public:
  explicit RestImportHandler(ddbServer&, GeneralRequest*, GeneralResponse*);
 ...
 private:
  ...
  ErrorCode handleSingleDocument(SingleCollectionTransaction& trx,
                                 ...
                                 darbotdb::velocypack::Builder& babies,
  ...
  void createVelocyPackObject(VPackBuilder&, darbotdb::velocypack::Slice const&,
                              darbotdb::velocypack::Slice const&, std::string&,
                              size_t);
  ...
  bool checkKeys(darbotdb::velocypack::Slice const&) const;
