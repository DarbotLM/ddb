...
RestUploadHandler::RestUploadHandler(ddbServer& server,
...
RestStatus RestUploadHandler::execute() {
  ...
  LOG_TOPIC("bbab9", TRACE, darbotdb::Logger::FIXME)
  ...
  if (found) {
    bool multiPart = darbotdb::basics::StringUtils::boolean(value);
