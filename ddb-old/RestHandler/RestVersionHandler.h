...
namespace darbotdb {
class RestVersionHandler : public darbotdb::RestBaseHandler {
 public:
  RestVersionHandler(ddbServer&, GeneralRequest*, GeneralResponse*);

 public:
  static void getVersion(ddbServer& server, bool allowInfo,
