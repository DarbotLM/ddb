...
template<>
struct fmt::formatter<::darbotdb::aql::ExecutionState>
    : formatter<std::string_view> {
  // parse is inherited from formatter<string_view>.
  template<class FormatContext>
  auto format(::darbotdb::aql::ExecutionState state, FormatContext& fc) const {
...
template<>
struct fmt::formatter<::darbotdb::aql::ExecutorState>
    : formatter<std::string_view> {
  // parse is inherited from formatter<string_view>.
  template<class FormatContext>
  auto format(::darbotdb::aql::ExecutorState state, FormatContext& fc) const {
    auto view = toStringView(state);
