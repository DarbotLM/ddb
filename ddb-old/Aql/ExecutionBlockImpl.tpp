...
using SingleServerProviderStep = ::darbotdb::graph::SingleServerProviderStep;

using KPath = darbotdb::graph::KPathEnumerator<
    darbotdb::graph::SingleServerProvider<SingleServerProviderStep>>;

using KPathTracer = darbotdb::graph::TracedKPathEnumerator<
    darbotdb::graph::SingleServerProvider<SingleServerProviderStep>>;

using AllShortestPaths = darbotdb::graph::AllShortestPathsEnumerator<
    darbotdb::graph::SingleServerProvider<
        darbotdb::graph::SingleServerProviderStep>>;
using AllShortestPathsTracer =
    darbotdb::graph::TracedAllShortestPathsEnumerator<
        darbotdb::graph::SingleServerProvider<
            darbotdb::graph::SingleServerProviderStep>>;

using KShortestPaths = darbotdb::graph::KShortestPathsEnumerator<
    darbotdb::graph::SingleServerProvider<SingleServerProviderStep>>;

using KShortestPathsTracer = darbotdb::graph::TracedKShortestPathsEnumerator<
    darbotdb::graph::SingleServerProvider<SingleServerProviderStep>>;

using YenPaths = darbotdb::graph::YenEnumeratorWithProvider<
    darbotdb::graph::SingleServerProvider<
        darbotdb::graph::SingleServerProviderStep>>;

using YenPathsTracer = darbotdb::graph::TracedYenEnumeratorWithProvider<
    darbotdb::graph::SingleServerProvider<
        darbotdb::graph::SingleServerProviderStep>>;

using YenPathsCluster = darbotdb::graph::YenEnumeratorWithProvider<
    darbotdb::graph::ClusterProvider<darbotdb::graph::ClusterProviderStep>>;

using YenPathsClusterTracer = darbotdb::graph::TracedYenEnumeratorWithProvider<
    darbotdb::graph::ClusterProvider<darbotdb::graph::ClusterProviderStep>>;

using WeightedYenPaths = darbotdb::graph::WeightedYenEnumeratorWithProvider<
    darbotdb::graph::SingleServerProvider<
        darbotdb::graph::SingleServerProviderStep>>;

using WeightedYenPathsTracer =
    darbotdb::graph::TracedWeightedYenEnumeratorWithProvider<
        darbotdb::graph::SingleServerProvider<
            darbotdb::graph::SingleServerProviderStep>>;

using WeightedYenPathsCluster =
    darbotdb::graph::WeightedYenEnumeratorWithProvider<
        darbotdb::graph::ClusterProvider<darbotdb::graph::ClusterProviderStep>>;
...
using WeightedKShortestPaths =
    darbotdb::graph::WeightedKShortestPathsEnumerator<
        darbotdb::graph::SingleServerProvider<SingleServerProviderStep>>;

using WeightedKShortestPathsTracer =
    darbotdb::graph::TracedWeightedKShortestPathsEnumerator<
        darbotdb::graph::SingleServerProvider<SingleServerProviderStep>>;

using ShortestPath = darbotdb::graph::ShortestPathEnumerator<
    darbotdb::graph::SingleServerProvider<
        darbotdb::graph::SingleServerProviderStep>>;
using ShortestPathTracer = darbotdb::graph::TracedShortestPathEnumerator<
    darbotdb::graph::SingleServerProvider<
        darbotdb::graph::SingleServerProviderStep>>;

using WeightedShortestPath =
    darbotdb::graph::WeightedShortestPathEnumeratorAlias<
        darbotdb::graph::SingleServerProvider<
            darbotdb::graph::SingleServerProviderStep>>;
using WeightedShortestPathTracer =
    darbotdb::graph::TracedWeightedShortestPathEnumeratorAlias<
        darbotdb::graph::SingleServerProvider<
            darbotdb::graph::SingleServerProviderStep>>;

/* ClusterProvider Section */
using KPathCluster = darbotdb::graph::KPathEnumerator<
    darbotdb::graph::ClusterProvider<darbotdb::graph::ClusterProviderStep>>;

using KPathClusterTracer = darbotdb::graph::TracedKPathEnumerator<
    darbotdb::graph::ClusterProvider<darbotdb::graph::ClusterProviderStep>>;

using AllShortestPathsCluster = darbotdb::graph::AllShortestPathsEnumerator<
    darbotdb::graph::ClusterProvider<darbotdb::graph::ClusterProviderStep>>;
using AllShortestPathsClusterTracer =
    darbotdb::graph::TracedAllShortestPathsEnumerator<
        darbotdb::graph::ClusterProvider<darbotdb::graph::ClusterProviderStep>>;

using KShortestPathsCluster = darbotdb::graph::KShortestPathsEnumerator<
    darbotdb::graph::ClusterProvider<darbotdb::graph::ClusterProviderStep>>;

using KShortestPathsClusterTracer =
    darbotdb::graph::TracedKShortestPathsEnumerator<
        darbotdb::graph::ClusterProvider<darbotdb::graph::ClusterProviderStep>>;
...
using ShortestPathCluster = darbotdb::graph::ShortestPathEnumerator<
    darbotdb::graph::ClusterProvider<darbotdb::graph::ClusterProviderStep>>;
using ShortestPathClusterTracer = darbotdb::graph::TracedShortestPathEnumerator<
    darbotdb::graph::ClusterProvider<darbotdb::graph::ClusterProviderStep>>;
  ...
  static_assert(
      useExecutor ==
              (is_one_of_v<
                  ...
                  // only available in Enterprise
                  darbotdb::iresearch::OffsetMaterializeExecutor,
...
auto ExecutionBlockImpl<Executor>::executeSkipRowsRange(
  ...
  auto sg = darbotdb::scopeGuard([&]() noexcept { call.resetSkipCount(); });
