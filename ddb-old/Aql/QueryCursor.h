...
class QueryResultCursor final : public darbotdb::Cursor {
 public:
 ...
 private:
  ...
  darbotdb::velocypack::ArrayIterator _iterator;
...
class QueryStreamCursor final : public Cursor {
 ...
 private:
  ...
  ExecutionState writeResult(darbotdb::velocypack::Builder& builder);
