...
DECLARE_HASH_FOR_IDENTIFIER(darbotdb::aql::ExecutionNodeId)

template<>
struct fmt::formatter<::darbotdb::aql::ExecutionNodeId>
    : fmt::formatter<::darbotdb::basics::Identifier> {
  template<class FormatContext>
  auto format(::darbotdb::aql::ExecutionNodeId nodeId,
              FormatContext& fc) const {
    return ::fmt::formatter<typename ::darbotdb::basics::Identifier>::format(
        nodeId, fc);
  }
};
