...
class TraversalExecutorInfos {
 public:
  ...
  TraversalExecutorInfos(
      ...
      std::string weightAttribute, darbotdb::aql::QueryContext& query,
      darbotdb::graph::PathValidatorOptions&& pathValidatorOptions,
      darbotdb::graph::OneSidedEnumeratorOptions&& enumeratorOptions,
  ...
  [[nodiscard]] auto traversalEnumerator() const
      -> darbotdb::graph::TraversalEnumerator*;
  ...
  auto parseTraversalEnumeratorSingleServer(
      ...
      darbotdb::aql::QueryContext& query,
      darbotdb::graph::SingleServerBaseProviderOptions&& baseProviderOptions,
      darbotdb::graph::PathValidatorOptions&& pathValidatorOptions,
      darbotdb::graph::OneSidedEnumeratorOptions&& enumeratorOptions,
  ...
  auto parseTraversalEnumeratorCluster(
      ...
      double defaultWeight, std::string const& weightAttribute,
      darbotdb::aql::QueryContext& query,
      darbotdb::graph::ClusterBaseProviderOptions&& baseProviderOptions,
      darbotdb::graph::PathValidatorOptions&& pathValidatorOptions,
      darbotdb::graph::OneSidedEnumeratorOptions&& enumeratorOptions,
      bool isSmart = false) -> void;
  ...
  darbotdb::aql::QueryContext& getQuery();
  darbotdb::aql::QueryWarnings& getWarnings();
 ...
 private:
  std::unique_ptr<darbotdb::graph::TraversalEnumerator> _traversalEnumerator =
      nullptr;
  ...
  darbotdb::aql::QueryContext& _query;
...
class TraversalExecutor {
 ...
 private:
  ...
  auto traversalEnumerator() -> darbotdb::graph::TraversalEnumerator*;
  ...
  darbotdb::graph::TraversalEnumerator* _traversalEnumerator;
};
