...
class SubqueryEndExecutorInfos {
 public:
  ...
  [[nodiscard]] darbotdb::ResourceMonitor& getResourceMonitor() const noexcept;
...
class SubqueryEndExecutor {
 ...
 private:
  ...
  class Accumulator {
   public:
    explicit Accumulator(darbotdb::ResourceMonitor& resourceMonitor,
   ...
   private:
    ...
    darbotdb::velocypack::Buffer<uint8_t> _buffer;
