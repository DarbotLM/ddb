...
class EnumerateCollectionExecutorInfos {
 public:
  ...
  darbotdb::aql::Projections const& getProjections() const noexcept;
  darbotdb::aql::Projections const& getFilterProjections() const noexcept;
 ...
 private:
  ...
  Expression* _filter;
  darbotdb::aql::Projections _projections;
  darbotdb::aql::Projections _filterProjections;
