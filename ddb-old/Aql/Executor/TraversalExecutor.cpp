...
darbotdb::aql::QueryContext& TraversalExecutorInfos::getQuery() {
  return _query;
}

darbotdb::aql::QueryWarnings& TraversalExecutorInfos::getWarnings() {
...
darbotdb::graph::TraversalEnumerator* TraversalExecutor::traversalEnumerator() {
  TRI_ASSERT(_traversalEnumerator != nullptr);
