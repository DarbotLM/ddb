...
template void functions::appendAsString<darbotdb::velocypack::StringSink>(
    velocypack::Options const& vopts, darbotdb::velocypack::StringSink& buffer,
    AqlValue const& value);

template void
functions::appendAsString<darbotdb::velocypack::SizeConstrainedStringSink>(
    velocypack::Options const& vopts,
    darbotdb::velocypack::SizeConstrainedStringSink& buffer,
    AqlValue const& value);
...
template void functions::stringify<darbotdb::velocypack::StringSink>(
    velocypack::Options const* vopts, darbotdb::velocypack::StringSink& buffer,
    darbotdb::velocypack::Slice slice);

template void
functions::stringify<darbotdb::velocypack::SizeConstrainedStringSink>(
    velocypack::Options const* vopts,
    darbotdb::velocypack::SizeConstrainedStringSink& buffer,
    darbotdb::velocypack::Slice slice);
