...
class WindowBounds final {
 ...
 private:
  ...
  darbotdb::basics::ParsedDuration _precedingDuration;
  darbotdb::basics::ParsedDuration _followingDuration;
...
class WindowNode : public ExecutionNode {
 ...
 public:
  ...
  WindowNode(ExecutionPlan*, darbotdb::velocypack::Slice base, WindowBounds&& b,
             Variable const* rangeVariable,
             std::vector<AggregateVarInfo> const& aggregateVariables);
