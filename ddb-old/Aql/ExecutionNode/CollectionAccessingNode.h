...
class CollectionAccessingNode : public DataAccessingNode {
 public:
  ...
  void toVelocyPack(darbotdb::velocypack::Builder& builder,
  ...
  void setPrototype(darbotdb::aql::Collection const* prototypeCollection,
                    darbotdb::aql::Variable const* prototypeOutVariable) final;
