...
IResearchViewNode* IResearchViewNode::getByVar(
  ...
  return aql::ExecutionNode::castTo<darbotdb::iresearch::IResearchViewNode*>(
      varOwner);
}
...
template class ::darbotdb::aql::IResearchViewMergeExecutor<
    ::darbotdb::aql::ExecutionTraits<
        false, false, false,
