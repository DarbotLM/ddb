...
class TraversalNode : public virtual GraphNode {
  class TraversalEdgeConditionBuilder final : public EdgeConditionBuilder {
   ...
   public:
    ...
    TraversalEdgeConditionBuilder(TraversalNode const* tn,
                                  darbotdb::velocypack::Slice condition);
    ...
    void toVelocyPack(darbotdb::velocypack::Builder& builder, bool verbose);
  };
 ...
 public:
  ...
  TraversalNode(ExecutionPlan* plan, darbotdb::velocypack::Slice base);
 ...
 public:
  ...
  std::vector<darbotdb::graph::IndexAccessor> buildIndexAccessor(
      TraversalEdgeConditionBuilder& conditionBuilder) const;
  std::vector<darbotdb::graph::IndexAccessor> buildUsedIndexes() const;
  std::unordered_map<uint64_t, std::vector<darbotdb::graph::IndexAccessor>>
