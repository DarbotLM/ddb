...
class IndexNode : public ExecutionNode,
 ...
 public:
  ...
  IndexNode(ExecutionPlan*, darbotdb::velocypack::Slice const& base);
  ...
  using IndexVarsInfo =
      std::unordered_map<std::vector<darbotdb::basics::AttributeName> const*,
                         IndexVariable>;
 ...
 private:
  ...
  darbotdb::aql::AstNode* makeUnique(AstNode*) const;
