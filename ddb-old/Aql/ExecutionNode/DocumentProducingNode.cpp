...
DocumentProducingNode::DocumentProducingNode(ExecutionPlan* plan,
  ...
  _count = darbotdb::basics::VelocyPackHelper::getBooleanValue(slice, "count",
                                                               false);
  _readOwnWrites =
      ReadOwnWrites{darbotdb::basics::VelocyPackHelper::getBooleanValue(
          slice, StaticStrings::ReadOwnWrites, false)};

  _useCache = darbotdb::basics::VelocyPackHelper::getBooleanValue(
...
void DocumentProducingNode::toVelocyPack(darbotdb::velocypack::Builder& builder,
