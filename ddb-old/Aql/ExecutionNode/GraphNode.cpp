...
GraphNode::GraphNode(ExecutionPlan* plan, velocypack::Slice base)
    : ExecutionNode(plan, base),
      ...
      _tmpIdNode(nullptr),
      _defaultDirection(
          uint64ToDirection(darbotdb::basics::VelocyPackHelper::stringUInt64(
              base.get("defaultDirection")))),
      _optionsBuilt(false),
      _isSmart(darbotdb::basics::VelocyPackHelper::getBooleanValue(
          base, StaticStrings::IsSmart, false)),
      _isDisjoint(darbotdb::basics::VelocyPackHelper::getBooleanValue(
  ...
  for (auto dirIt = vPackDirListIter.begin(), edgeIt = vPackEdgeColIter.begin();
       ...
       ++dirIt, ++edgeIt) {
    uint64_t dir = darbotdb::basics::VelocyPackHelper::stringUInt64(*dirIt);
    ...
    std::string e =
        darbotdb::basics::VelocyPackHelper::getStringValue(*edgeIt, "");
  ...
  for (VPackSlice it : VPackArrayIterator(vertexCollections)) {
    std::string v = darbotdb::basics::VelocyPackHelper::getStringValue(it, "");
