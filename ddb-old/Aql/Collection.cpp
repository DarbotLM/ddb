...
std::shared_ptr<darbotdb::Index> Collection::indexByIdentifier(
  ...
  auto iid = darbotdb::IndexId{darbotdb::basics::StringUtils::uint64(idxId)};
...
std::vector<std::shared_ptr<darbotdb::Index>> Collection::indexes() const {
