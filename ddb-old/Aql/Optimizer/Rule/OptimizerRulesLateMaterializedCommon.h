...
struct AstAndFieldData {
  ...
  // index data
  std::vector<darbotdb::basics::AttributeName> const* field{nullptr};
...
struct AttributeAndField {
  std::vector<darbotdb::basics::AttributeName> attr;
  T afData;
};
...
struct ColumnVariant {
  ...
  DataType* afData;
  size_t fieldNum;
  std::vector<darbotdb::basics::AttributeName> const* field;
  PostfixType postfix;
...
template<bool postfixLen>
bool isPrefix(std::vector<darbotdb::basics::AttributeName> const& prefix,
