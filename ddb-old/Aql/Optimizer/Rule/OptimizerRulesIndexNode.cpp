...
bool attributesMatch(darbotdb::transaction::Methods::IndexHandle const& index,
...
bool processCalculationNode(
    Variable const* var,
    darbotdb::transaction::Methods::IndexHandle const& index,
...
void darbotdb::aql::lateDocumentMaterializationRule(
