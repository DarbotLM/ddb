...
class VariableGenerator {
 public:
  ...
  VariableGenerator(darbotdb::ResourceMonitor& resourceMonitor);
  ...
  Variable* createVariable(darbotdb::velocypack::Slice);
  ...
  void fromVelocyPack(darbotdb::velocypack::Slice const allVariablesList);
