...
struct OptimizerRule {
  ...
  // for the current plan
    ...
    // removals of sort nodes for DDB-Search views.
    ...
    // for ddb search view
    lateDocumentMaterializationDDB-SearchRule,
  ...
  static_assert(
      handleConstrainedSortInView < lateDocumentMaterializationDDB-SearchRule,
