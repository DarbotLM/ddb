...
darbotdb::aql::SharedAqlItemBlockPtr::SharedAqlItemBlockPtr(
    darbotdb::aql::AqlItemBlock* aqlItemBlock) noexcept
...
constexpr darbotdb::aql::SharedAqlItemBlockPtr::SharedAqlItemBlockPtr(
    std::nullptr_t) noexcept
    : _aqlItemBlock(nullptr) {}

constexpr darbotdb::aql::SharedAqlItemBlockPtr::SharedAqlItemBlockPtr() noexcept
    : _aqlItemBlock(nullptr) {}
...
void darbotdb::aql::SharedAqlItemBlockPtr::decrRefCount() noexcept {
