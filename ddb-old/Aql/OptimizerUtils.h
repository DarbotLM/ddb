...
std::pair<bool, bool> getBestIndexHandlesForFilterCondition(
    ...
    darbotdb::aql::Ast* ast, darbotdb::aql::AstNode* root,
    darbotdb::aql::Variable const* reference,
    darbotdb::aql::SortCondition const* sortCondition, size_t itemsInCollection,
...
bool getBestIndexHandleForFilterCondition(
    ...
    darbotdb::aql::AstNode* node, darbotdb::aql::Variable const* reference,
