...
class MultiAqlItemBlockInputRange {
 public:
  ...
  std::pair<ExecutorState, darbotdb::aql::InputAqlItemRow> peekDataRow(
      size_t dependency) const;
  std::pair<ExecutorState, darbotdb::aql::InputAqlItemRow> nextDataRow(
      size_t dependency);
  ...
  darbotdb::aql::ShadowAqlItemRow peekShadowRow() const;
  std::pair<ExecutorState, darbotdb::aql::ShadowAqlItemRow> nextShadowRow();
