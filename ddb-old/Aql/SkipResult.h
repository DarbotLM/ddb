...
class SkipResult {
 public:
  ...
  auto toVelocyPack(darbotdb::velocypack::Builder& builder) const noexcept
      -> void;
...
std::ostream& operator<<(std::ostream&, darbotdb::aql::SkipResult const&);
