...
struct QueryCacheResultEntry {
  ...
  QueryCacheResultEntry(
      ...
      std::shared_ptr<darbotdb::velocypack::Builder> const& queryResult,
      std::shared_ptr<darbotdb::velocypack::Builder> const& bindVars,
  ...
  std::shared_ptr<darbotdb::velocypack::Builder> const _queryResult;
  std::shared_ptr<darbotdb::velocypack::Builder> const _bindVars;
  // stores datasource guid -> datasource name
  std::unordered_map<std::string, std::string> const _dataSources;
  std::shared_ptr<darbotdb::velocypack::Builder> _stats;
  size_t _size;
  size_t _rows;
  ...
  void toVelocyPack(darbotdb::velocypack::Builder& builder) const;
...
struct QueryCacheDatabaseEntry {
  ...
  std::shared_ptr<QueryCacheResultEntry> lookup(
      uint64_t hash, QueryString const& queryString,
      std::shared_ptr<darbotdb::velocypack::Builder> const& bindVars) const;
  ...
  void queriesToVelocyPack(darbotdb::velocypack::Builder& builder) const;
...
class QueryCache {
 ...
 public:
  ...
  /// @brief sets the cache properties
  void properties(darbotdb::velocypack::Slice const& properties);
 ...
 private:
  ...
  mutable darbotdb::basics::ReadWriteLock _entriesLock[numberOfParts];
