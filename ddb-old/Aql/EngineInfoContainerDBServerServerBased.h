...
class EngineInfoContainerDBServerServerBased {
 ...
 private:
  ...
  darbotdb::futures::Future<Result> buildSetupRequest(
  ...
  void addLockingPart(darbotdb::velocypack::Builder& builder,
                      ServerID const& server) const;

  // Insert the Options information into the message to be send to DBServers
  void addOptionsPart(darbotdb::velocypack::Builder& builder,
                      ServerID const& server) const;

  // Insert the Variables information into the message to be send to DBServers
  void addVariablesPart(darbotdb::velocypack::Builder& builder) const;
