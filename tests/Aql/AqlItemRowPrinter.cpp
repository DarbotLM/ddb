...
std::ostream& darbotdb::aql::operator<<(std::ostream& stream,
                                        RowType const& row) {
...
template std::ostream& darbotdb::aql::operator<<<InputAqlItemRow>(
    std::ostream& stream, InputAqlItemRow const& row);
template std::ostream& darbotdb::aql::operator<<<ShadowAqlItemRow>(
