...
using namespace darbotdb::tests;
...
TEST(ProjectionsTest, buildSingleKey) {
  ...
  EXPECT_EQ(darbotdb::aql::AttributeNamePath::Type::KeyAttribute, p[0].type);
  EXPECT_FALSE(p.isSingle("a"));
...
TEST(ProjectionsTest, buildSingleId) {
  ...
  EXPECT_EQ(darbotdb::aql::AttributeNamePath::Type::IdAttribute, p[0].type);
  EXPECT_FALSE(p.isSingle("a"));
...
TEST(ProjectionsTest, buildSingleFrom) {
  ...
  EXPECT_EQ(darbotdb::aql::AttributeNamePath::Type::FromAttribute, p[0].type);
  EXPECT_FALSE(p.isSingle("a"));
...
TEST(ProjectionsTest, buildSingleTo) {
  ...
  EXPECT_EQ(darbotdb::aql::AttributeNamePath::Type::ToAttribute, p[0].type);
  EXPECT_FALSE(p.isSingle("a"));
...
TEST(ProjectionsTest, buildSingleOther) {
  ...
  EXPECT_EQ(darbotdb::aql::AttributeNamePath::Type::SingleAttribute, p[0].type);
  EXPECT_FALSE(p.isSingle("a"));
...
TEST(ProjectionsTest, buildMulti) {
  ...
  EXPECT_EQ(darbotdb::aql::AttributeNamePath::Type::SingleAttribute, p[1].type);
  EXPECT_EQ(AttributeNamePath("c", resMonitor), p[2].path);
  EXPECT_EQ(darbotdb::aql::AttributeNamePath::Type::SingleAttribute, p[2].type);
  EXPECT_FALSE(p.isSingle("a"));
...
TEST(ProjectionsTest, buildWithSystem) {
  ...
  EXPECT_EQ(darbotdb::aql::AttributeNamePath::Type::KeyAttribute, p[1].type);
...
TEST(ProjectionsTest, buildNested1) {
  ...
  EXPECT_EQ(createAttributeNamePath({{"a"}, {"z"}, {"A"}}, resMonitor),
            p[2].path);
  EXPECT_EQ(darbotdb::aql::AttributeNamePath::Type::MultiAttribute, p[1].type);
  EXPECT_EQ(darbotdb::aql::AttributeNamePath::Type::MultiAttribute, p[2].type);
  EXPECT_FALSE(p.isSingle("a"));
  EXPECT_FALSE(p.isSingle("b"));
...
TEST(ProjectionsTest, buildNested2) {
  ...
  EXPECT_EQ(darbotdb::aql::AttributeNamePath::Type::MultiAttribute, p[3].type);
}
...
TEST(ProjectionsTest, buildOverlapping3) {
  ...
  EXPECT_EQ(darbotdb::aql::AttributeNamePath::Type::MultiAttribute, p[0].type);
}
