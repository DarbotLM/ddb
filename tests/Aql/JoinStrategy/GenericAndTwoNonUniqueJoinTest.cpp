...
using GenericJoinStrategy =
    darbotdb::aql::GenericMergeJoin<MyKeyValue, MyDocumentId>;
using TwoIndexNonUniqueJoinStrategy =
    darbotdb::aql::TwoIndicesMergeJoin<MyKeyValue, MyDocumentId>;
...
class GenericAndTwoNonUniqueIndexMerger
 ...
 protected:
  ...
  [[nodiscard]] static std::unique_ptr<
      darbotdb::aql::IndexJoinStrategy<MyKeyValue, MyDocumentId>>
