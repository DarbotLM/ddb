...
::darbotdb::aql::CostEstimate MockTypedNode::estimateCost() const {
  THROW_DDB_EXCEPTION(TRI_ERROR_NOT_IMPLEMENTED);
}

std::unique_ptr<::darbotdb::aql::ExecutionBlock> MockTypedNode::createBlock(
    ::darbotdb::aql::ExecutionEngine& engine) const {
  THROW_DDB_EXCEPTION(TRI_ERROR_NOT_IMPLEMENTED);
}

void MockTypedNode::doToVelocyPack(darbotdb::velocypack::Builder&,
