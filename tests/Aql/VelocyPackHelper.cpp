...
VPackBufferPtr darbotdb::tests::vpackFromJsonString(char const* c) {
...
VPackBufferPtr darbotdb::tests::operator"" _vpack(const char* json, size_t) {
  return vpackFromJsonString(json);
}

void darbotdb::tests::VPackToAqlItemBlock(VPackSlice data, RegisterCount nrRegs,
                                          AqlItemBlock& block) {
...
darbotdb::aql::SharedAqlItemBlockPtr darbotdb::tests::vPackBufferToAqlItemBlock(
...
std::vector<SharedAqlItemBlockPtr> darbotdb::tests::vPackToAqlItemBlocks(
