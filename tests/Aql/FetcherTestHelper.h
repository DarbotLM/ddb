...
class PatternTestWrapper {
 ...
 public:
  ...
  void shouldReturn(
      std::vector<std::pair<darbotdb::aql::ExecutionState,
                            darbotdb::aql::SharedAqlItemBlockPtr>>& toReturn) {
 ...
 private:
  ...
  DependencyProxyMock<::darbotdb::aql::BlockPassthrough::Disable>
...
/// line blocks.
static std::vector<std::pair<darbotdb::aql::ExecutionState,
