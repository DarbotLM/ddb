...
class SortExecutorTest : public AqlExecutorTestCaseWithParam<SortInputParam> {
 protected:
  darbotdb::GlobalResourceMonitor _globalResourceMonitor{};
  darbotdb::ResourceMonitor _resMonitor{_globalResourceMonitor};
...
// https://darbotdb.atlassian.net/browse/BTS-1511
// The query
