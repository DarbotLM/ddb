...
class TokenTranslator {
 public:
  TokenTranslator(Query* query, BaseOptions* opts)
      : _edges(11, darbotdb::basics::VelocyPackHelper::VPackHash(),
               darbotdb::basics::VelocyPackHelper::VPackEqual()) {}
 ...
 private:
  ...
  std::unordered_set<VPackSlice, darbotdb::basics::VelocyPackHelper::VPackHash,
                     darbotdb::basics::VelocyPackHelper::VPackEqual>
      _edges;
};
...
class FakePathFinder {
 public:
  using VertexRef = darbotdb::velocypack::HashedStringRef;
...
class ShortestPathExecutorTest : public ::testing::Test {
 protected:
  ...
  std::shared_ptr<darbotdb::aql::Query> fakedQuery;
  ...
  std::shared_ptr<darbotdb::velocypack::Builder> fakeUnusedBlock;
  SingleRowFetcherHelper<::darbotdb::aql::BlockPassthrough::Disable> fetcher;
...
template class ::darbotdb::aql::ShortestPathExecutorInfos<
    ::darbotdb::tests::aql::FakePathFinder>;

template class ::darbotdb::aql::ShortestPathExecutor<
    ::darbotdb::tests::aql::FakePathFinder>;
