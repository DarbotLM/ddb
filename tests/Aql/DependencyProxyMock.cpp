...
DependencyProxyMock<passBlocksThrough>::execute(AqlCallStack const& /*stack*/) {
  ...
  return {darbotdb::aql::ExecutionState::DONE, SkipResult{}, _block};
}
...
MultiDependencyProxyMock<passBlocksThrough>::MultiDependencyProxyMock(
    darbotdb::ResourceMonitor& monitor, RegIdSet const& inputRegisters,
    ::darbotdb::aql::RegisterCount nrRegisters, size_t nrDeps)
    : DependencyProxy<passBlocksThrough>({}, nrRegisters),
...
template class ::darbotdb::tests::aql::DependencyProxyMock<
    ::darbotdb::aql::BlockPassthrough::Enable>;
template class ::darbotdb::tests::aql::DependencyProxyMock<
    ::darbotdb::aql::BlockPassthrough::Disable>;

// Multiblock does not pass through
template class ::darbotdb::tests::aql::MultiDependencyProxyMock<
    ::darbotdb::aql::BlockPassthrough::Disable>;
