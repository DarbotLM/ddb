...
auto inspect(Inspector& f, TrivialMessages& x) {
  return f.variant(x).unqualified().alternatives(
      darbotdb::inspection::type<TrivialStart>("msg0"),
      darbotdb::inspection::type<TrivialMessage>("msg1"));
}
...
template<>
struct fmt::formatter<darbotdb::actor::test::TrivialState>
    : darbotdb::inspection::inspection_formatter {};
template<>
struct fmt::formatter<darbotdb::actor::test::message::TrivialMessages>
    : darbotdb::inspection::inspection_formatter {};
