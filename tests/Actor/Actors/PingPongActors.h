...
auto inspect(Inspector& f, PongMessage& x) {
  return f.variant(x).unqualified().alternatives(
      darbotdb::inspection::type<Start>("start"),
      darbotdb::inspection::type<Ping>("ping"));
}
...
struct PingMessage : std::variant<Start<PID>, Pong> {
  ...
  friend inline auto inspect(Inspector& f, PingMessage& x) {
    return f.variant(x).unqualified().alternatives(
        darbotdb::inspection::type<Start<PID>>("start"),
        darbotdb::inspection::type<Pong>("pong"));
  }
};
...
template<>
struct fmt::formatter<darbotdb::actor::test::ping_actor::PingState>
    : darbotdb::inspection::inspection_formatter {};
template<typename PID>
struct fmt::formatter<
    darbotdb::actor::test::ping_actor::message::PingMessage<PID>>
    : darbotdb::inspection::inspection_formatter {};
template<>
struct fmt::formatter<darbotdb::actor::test::pong_actor::PongState>
    : darbotdb::inspection::inspection_formatter {};
template<>
struct fmt::formatter<darbotdb::actor::test::pong_actor::message::PongMessage>
    : darbotdb::inspection::inspection_formatter {};
