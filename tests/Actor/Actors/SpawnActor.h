...
auto inspect(Inspector& f, SpawnActorMessage& x) {
  return f.variant(x).unqualified().alternatives(
      darbotdb::inspection::type<SpawnStartMessage>("start"),
      darbotdb::inspection::type<SpawnMessage>("spawn"));
}
...
template<>
struct fmt::formatter<darbotdb::actor::test::SpawnState>
    : darbotdb::inspection::inspection_formatter {};
template<>
struct fmt::formatter<darbotdb::actor::test::message::SpawnMessage>
    : darbotdb::inspection::inspection_formatter {};
