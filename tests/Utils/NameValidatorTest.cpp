...
TEST(NameValidatorTest, test_isSystemName) {
  EXPECT_FALSE(darbotdb::NameValidator::isSystemName(""));
  EXPECT_TRUE(darbotdb::NameValidator::isSystemName("_"));
  EXPECT_TRUE(darbotdb::NameValidator::isSystemName("_abc"));
  EXPECT_FALSE(darbotdb::NameValidator::isSystemName("abc"));
  EXPECT_FALSE(darbotdb::NameValidator::isSystemName("abc_"));
}
...
TEST(DatabaseNameValidatorTest, test_isAllowedName_traditionalNames) {
  ...
  {
    EXPECT_FALSE(darbotdb::DatabaseNameValidator::validateName(
                     false, false, std::string_view(nullptr, 0))
                     .ok());
    EXPECT_FALSE(darbotdb::DatabaseNameValidator::validateName(
                     false, false, std::string_view(""))
                     .ok());
    EXPECT_TRUE(darbotdb::DatabaseNameValidator::validateName(
...
TEST(CollectionNameValidatorTest, test_isAllowedName_traditionalNames) {
  ...
  std::string const tooLong(borderline.size() + 1, 'x');
  {
    EXPECT_FALSE(darbotdb::CollectionNameValidator::validateName(
                     false, false, std::string_view(nullptr, 0))
                     .ok());
    EXPECT_FALSE(darbotdb::CollectionNameValidator::validateName(
                     false, false, std::string_view(""))
                     .ok());
    EXPECT_TRUE(darbotdb::CollectionNameValidator::validateName(
                    false, false, std::string_view("abc123"))
                    .ok());
    EXPECT_FALSE(darbotdb::CollectionNameValidator::validateName(
                     false, false, std::string_view("123abc"))
...
TEST(IndexNameValidatorTest, test_isAllowedName_traditionalNames) {
  ...
  EXPECT_FALSE(darbotdb::IndexNameValidator::validateName(
                   false, std::string_view(nullptr, 0))
                   .ok());
  EXPECT_FALSE(
      darbotdb::IndexNameValidator::validateName(false, std::string_view(""))
          .ok());
  EXPECT_TRUE(darbotdb::IndexNameValidator::validateName(
  ...
  EXPECT_FALSE(darbotdb::IndexNameValidator::validateName(
                   ...
                   .ok());
  EXPECT_FALSE(
      darbotdb::IndexNameValidator::validateName(false, std::string_view("123"))
          .ok());
  EXPECT_FALSE(darbotdb::IndexNameValidator::validateName(
  ...
  EXPECT_TRUE(darbotdb::IndexNameValidator::validateName(
                  ...
                  .ok());
  EXPECT_FALSE(
      darbotdb::IndexNameValidator::validateName(false, std::string_view("_"))
          .ok());
  EXPECT_FALSE(
      darbotdb::IndexNameValidator::validateName(false, std::string_view(":"))
          .ok());
  ...
  EXPECT_FALSE(darbotdb::IndexNameValidator::validateName(
                   ...
                   .ok());
  EXPECT_FALSE(
      darbotdb::IndexNameValidator::validateName(false, std::string_view("a/b"))
          .ok());
  EXPECT_FALSE(
      darbotdb::IndexNameValidator::validateName(false, std::string_view("//"))
          .ok());
  ...
  // spaces
  EXPECT_FALSE(
      darbotdb::IndexNameValidator::validateName(false, std::string_view(" a"))
          .ok());
  EXPECT_FALSE(
      darbotdb::IndexNameValidator::validateName(false, std::string_view("a "))
          .ok());
...
TEST(IndexNameValidatorTest, test_isAllowedName_extendedNames) {
  ...
  EXPECT_FALSE(darbotdb::IndexNameValidator::validateName(
                   ...
                   .ok());
  EXPECT_FALSE(
      darbotdb::IndexNameValidator::validateName(true, std::string_view(""))
          .ok());
  EXPECT_TRUE(darbotdb::IndexNameValidator::validateName(
  ...
  EXPECT_FALSE(darbotdb::IndexNameValidator::validateName(
                   ...
                   .ok());
  EXPECT_FALSE(
      darbotdb::IndexNameValidator::validateName(true, std::string_view("123"))
          .ok());
  EXPECT_TRUE(
      darbotdb::IndexNameValidator::validateName(true, std::string_view("_123"))
          .ok());
  EXPECT_TRUE(
      darbotdb::IndexNameValidator::validateName(true, std::string_view("_abc"))
          .ok());
  EXPECT_TRUE(
      darbotdb::IndexNameValidator::validateName(true, std::string_view("abc_"))
          .ok());
  EXPECT_TRUE(
      darbotdb::IndexNameValidator::validateName(true, std::string_view("abc-"))
          .ok());
  EXPECT_TRUE(darbotdb::IndexNameValidator::validateName(
  ...
  EXPECT_FALSE(
      darbotdb::IndexNameValidator::validateName(true, std::string_view("/\\"))
          .ok());
  EXPECT_FALSE(
      darbotdb::IndexNameValidator::validateName(true, std::string_view("a/"))
          .ok());
  EXPECT_FALSE(
      darbotdb::IndexNameValidator::validateName(true, std::string_view("a/b"))
          .ok());
  EXPECT_TRUE(
      darbotdb::IndexNameValidator::validateName(true, std::string_view("a\\b"))
          .ok());
  ...
  EXPECT_TRUE(
      darbotdb::IndexNameValidator::validateName(true, std::string_view("😀 🍺"))
          .ok());
  EXPECT_TRUE(
      darbotdb::IndexNameValidator::validateName(true, std::string_view("maçã"))
          .ok());
  EXPECT_TRUE(darbotdb::IndexNameValidator::validateName(
...
TEST(AnalyzerNameValidatorTest, test_isAllowedName_traditionalNames) {
  ...
  EXPECT_FALSE(darbotdb::AnalyzerNameValidator::validateName(
                   false, std::string_view(nullptr, 0))
                   .ok());
  EXPECT_FALSE(
      darbotdb::AnalyzerNameValidator::validateName(false, std::string_view(""))
          .ok());
  EXPECT_TRUE(darbotdb::AnalyzerNameValidator::validateName(
                  false, std::string_view("abc123"))
                  .ok());
  EXPECT_TRUE(darbotdb::AnalyzerNameValidator::validateName(
                  false, std::string_view("Abc123"))
...
TEST(AnalyzerNameValidatorTest, test_isAllowedName_extendedNames) {
  ...
  EXPECT_FALSE(darbotdb::AnalyzerNameValidator::validateName(
                   ...
                   .ok());
  EXPECT_FALSE(
      darbotdb::AnalyzerNameValidator::validateName(true, std::string_view(""))
          .ok());
  EXPECT_TRUE(darbotdb::AnalyzerNameValidator::validateName(
                  true, std::string_view("abc123"))
                  .ok());
...
TEST(ViewNameValidatorTest, test_isAllowedName_traditionalNames) {
  ...
  {
    EXPECT_FALSE(darbotdb::ViewNameValidator::validateName(
                     false, false, std::string_view(nullptr, 0))
                     .ok());
    EXPECT_FALSE(darbotdb::ViewNameValidator::validateName(false, false,
                                                           std::string_view(""))
                     .ok());
    EXPECT_TRUE(darbotdb::ViewNameValidator::validateName(
                    false, false, std::string_view("abc123"))
                    .ok());
    EXPECT_TRUE(darbotdb::ViewNameValidator::validateName(
                    false, false, std::string_view("Abc123"))
  ...
  // direct (system)
  {
    EXPECT_FALSE(darbotdb::ViewNameValidator::validateName(
                     true, false, std::string_view(nullptr, 0))
                     .ok());
    EXPECT_FALSE(darbotdb::ViewNameValidator::validateName(true, false,
                                                           std::string_view(""))
                     .ok());
    EXPECT_TRUE(darbotdb::ViewNameValidator::validateName(
                    true, false, std::string_view("abc123"))
...
TEST(ViewNameValidatorTest, test_isAllowedName_extendedNames) {
...

  {
    EXPECT_FALSE(darbotdb::ViewNameValidator::validateName(
                     false, true, std::string_view(nullptr, 0))
                     .ok());
    EXPECT_FALSE(darbotdb::ViewNameValidator::validateName(false, true,
                                                           std::string_view(""))
                     .ok());
    EXPECT_TRUE(darbotdb::ViewNameValidator::validateName(
                    false, true, std::string_view("abc123"))
    ...
    EXPECT_FALSE(darbotdb::ViewNameValidator::validateName(
                     false, true, std::string_view("_"))
                     .ok());
    EXPECT_TRUE(darbotdb::ViewNameValidator::validateName(false, true,
                                                          std::string_view(":"))
                    .ok());
    EXPECT_TRUE(darbotdb::ViewNameValidator::validateName(
                    false, true, std::string_view("abc:d"))
  ...
  // direct (system)
  {
    EXPECT_FALSE(darbotdb::ViewNameValidator::validateName(
                     true, true, std::string_view(nullptr, 0))
                     .ok());
    EXPECT_FALSE(darbotdb::ViewNameValidator::validateName(true, true,
                                                           std::string_view(""))
                     .ok());
    EXPECT_TRUE(darbotdb::ViewNameValidator::validateName(
                    true, true, std::string_view("abc123"))
  ...
  EXPECT_TRUE(darbotdb::ViewNameValidator::validateName(
                  true, true, std::string_view("mötör"))
                  .ok());
  EXPECT_TRUE(darbotdb::ViewNameValidator::validateName(true, true,
                                                        std::string_view("😀"))
                  .ok());
  EXPECT_TRUE(darbotdb::ViewNameValidator::validateName(true, true,
                                                        std::string_view("😀 🍺"))
