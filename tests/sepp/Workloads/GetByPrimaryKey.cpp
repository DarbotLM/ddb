...
namespace darbotdb::sepp::workloads {
...
void GetByPrimaryKey::Thread::run() {
  ...
  rocksdb::ColumnFamilyHandle* docCF =
      darbotdb::RocksDBColumnFamilyManager::get(
          darbotdb::RocksDBColumnFamilyManager::Family::Documents);
  rocksdb::ColumnFamilyHandle* indexCF =
      darbotdb::RocksDBColumnFamilyManager::get(
          darbotdb::RocksDBColumnFamilyManager::Family::PrimaryIndex);

  auto& engine =
      _server.vocbase()->server().getFeature<darbotdb::RocksDBEngine>();
