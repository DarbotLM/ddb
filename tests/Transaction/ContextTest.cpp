...
TEST_F(TransactionContextTest, StandaloneSmartContext) {
  ...
  auto params = darbotdb::velocypack::Parser::fromJson(
      "{ \"name\": \"testCollection\" }");
  ...
  auto docs = darbotdb::velocypack::Parser::fromJson(
  ...
  {
    auto query = darbotdb::aql::Query::create(ctx, queryString, bindVars);
