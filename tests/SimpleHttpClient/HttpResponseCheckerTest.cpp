...
///
/// @author Julia Puget
/// @author Copyright 2021, darbotdb GmbH, Cologne, Germany
////////////////////////////////////////////////////////////////////////////////
...
TEST(HttpResponseCheckerTest, testErrorResponse) {
  ...
  response->setResultType(
      darbotdb::httpclient::SimpleHttpResult::ResultType::COULD_NOT_CONNECT);
...
TEST(HttpResponseCheckerTest, testErrorResponse2) {
  std::unique_ptr<httpclient::SimpleHttpResult> response =
      std::make_unique<httpclient::SimpleHttpResult>();
  response->setResultType(
      darbotdb::httpclient::SimpleHttpResult::ResultType::COMPLETE);
