...
class TestProgressHandler : public darbotdb::application_features::
 ...
 public:
  ...
  void StateChange(
      darbotdb::application_features::ApplicationServer::State newState) {
    if (darbotdb::application_features::ApplicationServer::State::IN_WAIT ==
        newState) {
  ...
  darbotdb::basics::ConditionVariable _serverReadyCond;
...
//
class TestMaintenanceFeature : public darbotdb::MaintenanceFeature {
 public:
  TestMaintenanceFeature(darbotdb::ArangodServer& as)
      : darbotdb::MaintenanceFeature(as) {
  ...
  void validateOptions(
      std::shared_ptr<darbotdb::options::ProgramOptions> options) override {}
  ...
  virtual darbotdb::Result addAction(
      std::shared_ptr<darbotdb::maintenance::Action> action) override {
    _recentAction = action;
    return MaintenanceFeature::addAction(action);
  }

  virtual darbotdb::Result addAction(
      std::shared_ptr<darbotdb::maintenance::ActionDescription> const&
