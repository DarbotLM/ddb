...
void IResearchInvertedIndexMock::toVelocyPack(
  ...
  builder.add(darbotdb::StaticStrings::IndexId,
              darbotdb::velocypack::Value(std::to_string(_iid.id())));
  builder.add(darbotdb::StaticStrings::IndexType,
              darbotdb::velocypack::Value(oldtypeName(type())));
  builder.add(darbotdb::StaticStrings::IndexName,
              darbotdb::velocypack::Value(name()));
  builder.add(darbotdb::StaticStrings::IndexUnique, VPackValue(unique()));
  builder.add(darbotdb::StaticStrings::IndexSparse, VPackValue(sparse()));
...
bool IResearchInvertedIndexMock::covers(
    darbotdb::aql::Projections& projections) const {
