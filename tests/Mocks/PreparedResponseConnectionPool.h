...
class PreparedRequestResponse {
 public:
  ...
  void setRequestType(darbotdb::rest::RequestType type);
 ...
 private:
  ...
  std::shared_ptr<darbotdb::velocypack::Buffer<uint8_t>> _payload;
...
class PreparedResponseConnectionPool final
 ...
 public:
  explicit PreparedResponseConnectionPool(
      darbotdb::AgencyCache& agencyCache,
      darbotdb::network::ConnectionPool::Config const& config);
