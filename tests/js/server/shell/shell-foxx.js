...
// /
/// @author Lucas Dohmen
/// @author Copyright 2014, darbotdb GmbH, Cologne, Germany
...
var stub,
  ...
  mockConstructor,
  joi = require("joi"),
  transformRoute = require("@darbotdb/foxx/legacy/routing").__test_transformControllerToRoute,
  _ = require("lodash");
...
var jsunity = require("jsunity"),
  FoxxController = require("@darbotdb/foxx/legacy").Controller,
  fakeContext,
...
function DocumentationAndConstraintsSpec () {
  ...
  return {
    setUp: function () {
      ...
      routes = app.routingInfo.routes;
      models = app.models;
      Model = require('@darbotdb/foxx/legacy').Model;
    },
