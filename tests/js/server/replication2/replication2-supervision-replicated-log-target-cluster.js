...
const helper = require("@darbotdb/testutils/replicated-logs-helper");
...
const replicatedLogSuite = function () {
  const targetConfig = {
    writeConcern: 2,
    softWriteConcern: 2,
    // TODO Set waitForSync to false after https://darbotdb.atlassian.net/browse/CINFRA-755 is finished.
    //      This is tracked in https://darbotdb.atlassian.net/browse/CINFRA-783.
    waitForSync: true,
  };
