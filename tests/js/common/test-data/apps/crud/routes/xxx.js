...
const DDB_NOT_FOUND = errors.ERROR_DDB_DOCUMENT_NOT_FOUND.code;
const DDB_DUPLICATE = errors.ERROR_DDB_UNIQUE_CONSTRAINT_VIOLATED.code;
const DDB_CONFLICT = errors.ERROR_DDB_CONFLICT.code;
...
router.post(function (req, res) {
  ...
  try {
    ...
    if (e.isArangoError && e.errorNum === DDB_DUPLICATE) {
...
router.get(':key', function (req, res) {
  ...
  try {
    ...
    if (e.isArangoError && e.errorNum === DDB_NOT_FOUND) {
...
router.put(':key', function (req, res) {
  ...
  try {
    ...
    if (e.isArangoError && e.errorNum === DDB_CONFLICT) {
      throw httpError(HTTP_CONFLICT, e.message);
    }
    throw e;
  }
