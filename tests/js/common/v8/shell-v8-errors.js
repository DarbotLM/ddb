...
var ArangoError = require("@darbotdb").ArangoError;
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testArangoErrorMessage : function () {
      try {
        throwError(ERRORS.ERROR_DDB_DOCUMENT_TYPE_INVALID.code, ERRORS.ERROR_DDB_DOCUMENT_TYPE_INVALID.message);
        fail();
      }
      catch (err) {
        assertEqual(ERRORS.ERROR_DDB_DOCUMENT_TYPE_INVALID.code, err.errorNum);
        assertEqual(ERRORS.ERROR_DDB_DOCUMENT_TYPE_INVALID.message, err.errorMessage);
      }
    },
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testArangoToString1 : function () {
      var e = ERRORS.ERROR_DDB_DOCUMENT_TYPE_INVALID;
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testArangoToString2 : function () {
      var e = ERRORS.ERROR_DDB_DOCUMENT_NOT_FOUND;
