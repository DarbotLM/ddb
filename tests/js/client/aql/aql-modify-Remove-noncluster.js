  ...
  for (let index in results) {
    if (results.hasOwnProperty(index)) {
      try {
        ...
        assertEqual(errors.ERROR_DDB_DOCUMENT_NOT_FOUND.code, e.errorNum, "unexpected error code (" + e.errorMessage + "): ");
      }
    }
  }
};
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testRemoveInvalid1What : function () {
      assertQueryError(errors.ERROR_DDB_DOCUMENT_TYPE_INVALID.code, "FOR d IN @@cn REMOVE d.foobar IN @@cn LET removed = OLD RETURN removed", { "@cn": cn1 });
      assertEqual(100, c1.count());
    },
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testRemoveInvalid4 : function () {
      assertQueryError(errors.ERROR_DDB_DOCUMENT_NOT_FOUND.code, "FOR i iN 0..100 REMOVE CONCAT('test', TO_STRING(i)) IN @@cn", { "@cn": cn1 });
      assertEqual(100, c1.count());
    },
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testSingleRemoveNotFoundWhat : function () {
      assertQueryError(errors.ERROR_DDB_DOCUMENT_NOT_FOUND.code, "REMOVE 'foobar' IN @@cn LET removed = OLD RETURN removed", { "@cn": cn1 });
    },
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testTwoCollectionsNotFoundWhat : function () {
      assertQueryError(errors.ERROR_DDB_DOCUMENT_NOT_FOUND.code, "FOR d IN @@cn1 REMOVE { _key: d._key } IN @@cn2 LET removed = OLD RETURN removed", { "@cn1": cn1, "@cn2": cn2 });
