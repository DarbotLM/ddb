...
////////////////////////////////////////////////////////////////////////////////
    ...
    testInvalidUsageOfNew : function () {
      assertQueryError(errors.ERROR_DDB_DATA_SOURCE_NOT_FOUND.code, "REMOVE 'abc' IN @@cn LET removed = NEW RETURN removed", { "@cn": cn1 });
    },
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testInvalidUsageOfOld : function () {
      assertQueryError(errors.ERROR_DDB_DATA_SOURCE_NOT_FOUND.code, "INSERT { } IN @@cn LET inserted = OLD RETURN inserted", { "@cn": cn1 });
    },
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testInvalidVariableNames2 : function () {
      assertQueryError(errors.ERROR_DDB_DATA_SOURCE_NOT_FOUND.code, "REMOVE 'abc' IN @@cn LET removed1 = OLD RETURN removed2", { "@cn": cn1 });
    },
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testInvalidVariableNames4 : function () {
      assertQueryError(errors.ERROR_DDB_DATA_SOURCE_NOT_FOUND.code, "UPDATE 'abc' WITH { } IN @@cn LET updated = NEW RETURN foo", { "@cn": cn1 });
    },
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testUpsertInvalidDocumentsInsert : function () {
      ...
      queries.forEach(function(query) { 
        const params = query[1];
        params["@cn"] = cn1;
        assertQueryError(errors.ERROR_DDB_DOCUMENT_TYPE_INVALID.code, query[0], params, query[0]);
      });
    },
