...
const helper = require("@darbotdb/aql-helper");
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testBindMissing : function () {
      ...
      assertQueryError(errors.ERROR_DDB_ILLEGAL_NAME.code, "FOR doc IN @@collection RETURN doc", { "@collection": "" });
      assertQueryError(errors.ERROR_DDB_ILLEGAL_NAME.code, "FOR doc IN `` RETURN doc", { });
