...
////////////////////////////////////////////////////////////////////////////////
    ...
    testUpdateUniqueConstraint1 : function () {
      ...
      assertQueryError(errors.ERROR_DDB_UNIQUE_CONSTRAINT_VIOLATED.code, "FOR d IN @@cn UPDATE d._key WITH { value1: 1 } IN @@cn", { "@cn": cn1 });
    },
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testUpdateUniqueConstraint2 : function () {
      ...
      assertQueryError(errors.ERROR_DDB_UNIQUE_CONSTRAINT_VIOLATED.code, "FOR d IN @@cn UPDATE d._key WITH { value3: 1 } IN @@cn", { "@cn": cn1 });
    },
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testSingleUpdateNotFoundWhatNew : function () {
      assertQueryError(errors.ERROR_DDB_DOCUMENT_NOT_FOUND.code, "UPDATE { _key: 'foobar' } WITH { value1: 1 } IN @@cn LET updated = NEW RETURN updated", { "@cn": cn1 });
    },
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testUpsertInsertUniqueConstraint1 : function () {
      assertQueryError(errors.ERROR_DDB_UNIQUE_CONSTRAINT_VIOLATED.code, "FOR i IN 1..100 UPSERT { notHere: true } INSERT { _key: 'test' } UPDATE { } IN @@cn", { "@cn": cn1 });
      assertEqual(100, c1.count());
    },
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testUpsertInsertUniqueConstraint2 : function () {
      assertQueryError(errors.ERROR_DDB_UNIQUE_CONSTRAINT_VIOLATED.code, "FOR d IN @@cn UPSERT { notHere: true } INSERT d UPDATE { } IN @@cn", { "@cn": cn1 });
      assertEqual(100, c1.count());
    },
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testUpsertEdgeInvalid : function () {
      ...
      assertQueryError(errors.ERROR_DDB_INVALID_EDGE_ATTRIBUTE.code, "FOR i IN 1..50 UPSERT { foo: 1 } INSERT { foo: 'bar'} UPDATE { } INTO @@cn", { "@cn": edge.name() });
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testUpsertEdgeNoFrom : function () {
      ...
      assertQueryError(errors.ERROR_DDB_INVALID_EDGE_ATTRIBUTE.code, "FOR i IN 1..50 UPSERT { foo: 1 } INSERT { _to: CONCAT('UnitTestsAhuacatlUpdate1/', TO_STRING(i)) } UPDATE { } INTO @@cn", { "@cn": edge.name() });
      assertEqual(0, edge.count());
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testUpsertEdgeNoTo : function () {
      ...
      assertQueryError(errors.ERROR_DDB_INVALID_EDGE_ATTRIBUTE.code, "FOR i IN 1..50 UPSERT { foo: 1 } INSERT { _from: CONCAT('UnitTestsAhuacatlUpdate1/', TO_STRING(i)) } UPDATE { } INTO @@cn", { "@cn": edge.name() });
      assertEqual(0, edge.count());
