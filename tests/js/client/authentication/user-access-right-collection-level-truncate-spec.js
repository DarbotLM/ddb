...
const users = require('@darbotdb/users');
const helper = require('@darbotdb/testutils/user-helper');
              ...
              it('via js', () => {
                ...
                if ((dbLevel['rw'].has(name) || dbLevel['ro'].has(name)) &&
                  ...
                  try {
                    ...
                    const err = colLevel['ro'].has(name) ? errors.ERROR_DDB_READ_ONLY : errors.ERROR_FORBIDDEN;
