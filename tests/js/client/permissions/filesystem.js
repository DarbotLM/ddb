...
/// @author Copyright 2019, darbotdb Inc, Cologne, Germany
// //////////////////////////////////////////////////////////////////////////////
...
function testSuite() {
  function tryReadForbidden(fn) {
    try {
      ...
      assertEqual(darbotdb.ERROR_FORBIDDEN, err.errorNum, 'access to ' + fn + ' wasn\'t forbidden');
    }
  }
  ...
  function tryAdler32Forbidden(fn) {
    try {
      ...
      assertEqual(darbotdb.ERROR_FORBIDDEN, err.errorNum, 'access to ' + fn + ' wasn\'t forbidden: ' + err);
    }
  }
  ...
  function tryWriteForbidden(fn) {
    try {
      ...
      assertEqual(darbotdb.ERROR_FORBIDDEN, err.errorNum, 'Write access to ' + fn + ' wasn\'t forbidden');
    }
  }
  ...
  function tryAppendForbidden(fn) {
    try {
      ...
      assertEqual(darbotdb.ERROR_FORBIDDEN, err.errorNum, 'Append access to ' + fn + ' wasn\'t forbidden');
    }
  }
  ...
  function tryChmodForbidden(fn) {
    try {
      ...
      assertEqual(darbotdb.ERROR_FORBIDDEN, err.errorNum, 'chmod access to ' + fn + ' wasn\'t forbidden');
    }
  }
  ...
  function tryExistsForbidden(fn) {
    try {
      ...
      assertEqual(darbotdb.ERROR_FORBIDDEN, err.errorNum, 'stat-access to ' + fn + ' wasn\'t forbidden');
    }
    try {
      let rc = fs.mtime(fn);
      fail();
  ...
  function tryIsDirectoryForbidden(fn) {
    try {
      ...
      assertEqual(darbotdb.ERROR_FORBIDDEN, err.errorNum, 'isDirectory-access to ' + fn + ' wasn\'t forbidden');
    }
  }
  ...
  function tryCreateDirectoryForbidden(fn) {
    try {
      ...
      assertEqual(darbotdb.ERROR_FORBIDDEN, err.errorNum, 'createDirectory creation of ' + fn + ' wasn\'t forbidden');
    }
  }
  ...
  function tryRemoveDirectoryForbidden(fn) {
    try {
      ...
      assertEqual(darbotdb.ERROR_FORBIDDEN, err.errorNum, 'removeDirectory deleting of ' + fn + ' wasn\'t forbidden');
    }
  }
  ...
  function tryRemoveDirectoryRecursiveForbidden(fn) {
    try {
      ...
      assertEqual(darbotdb.ERROR_FORBIDDEN, err.errorNum, 'removeDirectoryRecursive deletion of ' + fn + ' wasn\'t forbidden');
    }
  }
  ...
  function tryIsFileForbidden(fn) {
    try {
      ...
      assertEqual(darbotdb.ERROR_FORBIDDEN, err.errorNum, 'isFile-access to ' + fn + ' wasn\'t forbidden');
    }
  }
  ...
  function tryListFileForbidden(dn) {
    try {
      ...
      assertEqual(darbotdb.ERROR_FORBIDDEN, err.errorNum, 'ListFile-access to ' + dn + ' wasn\'t forbidden');
    }
  }
  ...
  function tryListTreeForbidden(dn) {
    try {
      ...
      assertEqual(darbotdb.ERROR_FORBIDDEN, err.errorNum, 'ListTree-access to ' + dn + ' wasn\'t forbidden');
    }
  }
  ...
  function tryGetTempFileForbidden(dn) {
    try {
      ...
      assertEqual(darbotdb.ERROR_FORBIDDEN, err.errorNum, 'Temfile-access to ' + dn + ' wasn\'t forbidden');
    }
  }
  ...
  function tryMakeAbsoluteForbidden(fn) {
    try {
      ...
      assertEqual(darbotdb.ERROR_FORBIDDEN, err.errorNum, 'Absolute expansion to ' + fn + ' wasn\'t forbidden');
    }
  }
  ...
  function tryCopyFileForbidden(sn, tn) {
    try {
      ...
      assertEqual(darbotdb.ERROR_FORBIDDEN, err.errorNum, 'Copying of ' + sn + ' to ' + tn + ' wasn\'t forbidden');
    }
  }
  ...
  function tryCopyRecursiveFileForbidden(sn, tn) {
    try {
      ...
      assertEqual(darbotdb.ERROR_FORBIDDEN, err.errorNum, 'CopyRecursiveing of ' + sn + ' to ' + tn + ' wasn\'t forbidden: ' + err);
    }
  }
  ...
  function tryMoveFileForbidden(sn, tn) {
    try {
      ...
      assertEqual(darbotdb.ERROR_FORBIDDEN, err.errorNum, 'Moving of ' + sn + ' to ' + tn + ' wasn\'t forbidden');
    }
  }
  ...
  function tryRemoveFileForbidden(fn) {
    try {
      ...
      assertEqual(darbotdb.ERROR_FORBIDDEN, err.errorNum, 'removing of ' + fn + ' wasn\'t forbidden');
    }
  }
  ...
  function tryZipFileForbidden(zip, sn) {
    try {
      ...
      assertEqual(darbotdb.ERROR_FORBIDDEN, err.errorNum, 'Zipping of ' + zip + ' to ' + sn + ' wasn\'t forbidden: ' + err);
    }
  }
  ...
  function tryUnZipFileForbidden(zip, sn) {
    try {
      ...
      assertEqual(darbotdb.ERROR_FORBIDDEN, err.errorNum, 'Unzipping of ' + zip + ' to ' + sn + ' wasn\'t forbidden: ' + err);
    }
  }
  ...
  function tryJSParseFileForbidden(fn) {
    try {
      ...
      assertEqual(darbotdb.ERROR_FORBIDDEN, err.errorNum, "wasn't forbidden to parse: " + fn);
    }
  }
  ...
  function tryJSEvalFileForbidden(fn) {
    try {
      ...
      assertEqual(darbotdb.ERROR_FORBIDDEN, err.errorNum, "wasn't forbidden to load: " + fn);
    }
  }
