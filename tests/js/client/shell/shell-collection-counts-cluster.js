...
const { deriveTestSuite, getEndpointById, getMetric, waitForShardsInSync } = require('@darbotdb/test-helper');
...
function BaseTestConfig () {
  ...
  return {
    ...
    testWrongCountOnFollowerIncrementalSyncManyFailures : function () {
      ...
      let checksumFailuresBefore = getMetric(followerUrl, "darbotdb_sync_wrong_checksum_total");
      ...
      try {
        ...
        while (tries++ < 120) {
          checksumFailuresAfter = getMetric(followerUrl, "darbotdb_sync_wrong_checksum_total");
