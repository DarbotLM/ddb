...
const aqlfunctions = require("@darbotdb/aql/functions");
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testQueryReturnError : function () {
      ...
      aqlfunctions.register("UnitTests::tryme", function (what) {
        const error = require("@darbotdb").errors.ERROR_QUERY_FUNCTION_ARGUMENT_NUMBER_MISMATCH;
      ...
      assertEqual(warn.code, require("@darbotdb").errors.ERROR_QUERY_FUNCTION_ARGUMENT_NUMBER_MISMATCH.code);
