  ...
  return {
    ...
    testNestingLevelArrayTooDeep: function () {
      ...
      try {
        ...
        assertEqual(darbotdb.errors.ERROR_BAD_PARAMETER.code, err.errorNum);
      }
    },
    ...
    testErrorHandlingArangoError: function () {
      try {
        db._executeTransaction({
          ...
          action: function () {
            const darbotdb = require('@darbotdb');
            var err = new darbotdb.ArangoError();
            err.errorNum = darbotdb.ERROR_BAD_PARAMETER;
        ...
        assertEqual(darbotdb.ERROR_BAD_PARAMETER, err.errorNum);
      }
    },
