...
////////////////////////////////////////////////////////////////////////////////
  ...
  let executeReplace = function (c) {
    ...
    try {
      ...
      assertEqual(ERRORS.ERROR_DDB_CONFLICT.code, err1.errorNum);
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  let executeReplaceShardKeys = function (c) {
    ...
    try {
      ...
      if (err2.errorNum !== ERRORS.ERROR_DDB_DOCUMENT_NOT_FOUND.code) {
    ...
    try {
      ...
      if (err3.errorNum !== ERRORS.ERROR_CLUSTER_MUST_NOT_CHANGE_SHARDING_ATTRIBUTES.code) {
        assertEqual(ERRORS.ERROR_DDB_DOCUMENT_NOT_FOUND.code, err3.errorNum);
      } else {
    ...
    try {
      ...
      assertEqual(ERRORS.ERROR_DDB_DOCUMENT_NOT_FOUND.code, err4.errorNum);
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  let executeDelete = function (c) {
    ...
    try {
      ...
      assertEqual(ERRORS.ERROR_DDB_DOCUMENT_NOT_FOUND.code, err1.errorNum);
    }
    ...
    try {
      ...
      assertEqual(ERRORS.ERROR_DDB_CONFLICT.code, err2.errorNum);
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  let executeDocument = function (c) {
    ...
    try {
      ...
      assertEqual(ERRORS.ERROR_DDB_CONFLICT.code, err3.errorNum);
    }
...
////////////////////////////////////////////////////////////////////////////////
  ...
  let executeExists = function (c) {
    ...
    try {
      ...
      assertEqual(e.errorNum, ERRORS.ERROR_DDB_CONFLICT.code);
    }
