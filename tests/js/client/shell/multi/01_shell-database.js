...
////////////////////////////////////////////////////////////////////////////////
    ...
    testLongName : function () {
      ...
      try {
        ...
        assertEqual(ERRORS.ERROR_DDB_ILLEGAL_NAME.code, err.errorNum);
      }
    },
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testQueryHelper : function () {
      var query = require("@darbotdb").query;
    ...
    testCreateDatabaseInvalidName : function () {
      ...
      [ "", " ", "/", "0", "99999", ":::", "fox::", "test/abc" ].forEach (function (d) {
        try {
          ...
          assertEqual(ERRORS.ERROR_DDB_ILLEGAL_NAME.code, err.errorNum, d);
        }
      });
    },
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testCreateDatabaseNonSystem : function () {
      ...
      try {
        ...
        assertEqual(ERRORS.ERROR_DDB_USE_SYSTEM_DATABASE.code, err2.errorNum);
      }
      ...
      try {
        ...
        assertEqual(ERRORS.ERROR_DDB_USE_SYSTEM_DATABASE.code, err3.errorNum);
      }
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testCreateDatabaseDuplicate : function () {
      ...
      try {
        ...
        assertEqual(ERRORS.ERROR_DDB_DUPLICATE_NAME.code, err2.errorNum);
      }
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testUseDatabase : function () {
      ...
      try {
        ...
        assertTrue(err2.errorNum === ERRORS.ERROR_DDB_DATABASE_NOT_FOUND.code ||
      ...
      try {
        ...
        assertTrue(err3.errorNum === ERRORS.ERROR_DDB_DATABASE_NOT_FOUND.code ||
