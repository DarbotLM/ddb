...
////////////////////////////////////////////////////////////////////////////////
    ...
    testErrorHandlingBadHandleDatabase : function () {
      try {
        ...
        assertEqual(ERRORS.ERROR_DDB_DOCUMENT_HANDLE_BAD.code, err.errorNum);
      }
    },
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testErrorHandlingUnknownDocument: function () {
      try {
        ...
        assertEqual(ERRORS.ERROR_DDB_DOCUMENT_NOT_FOUND.code, err.errorNum);
      }
    },
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testErrorHandlingCrossCollection : function () {
      try {
        ...
        assertEqual(ERRORS.ERROR_DDB_CROSS_COLLECTION_REQUEST.code, err.errorNum);
      }
    },
    ...
    testSaveInvalidDocumentType : function () {
      [ 1, 2, 3, false, true, null ].forEach(function (doc) {
        try {
          ...
          assertEqual(ERRORS.ERROR_DDB_DOCUMENT_TYPE_INVALID.code, err.errorNum);
        }
      });
    },
    ...
    testSaveInvalidDocumentKeyType : function () {
      [ 1, 2, 3, false, true, null, [ ], { } ].forEach(function (key) {
        try {
          ...
          assertEqual(ERRORS.ERROR_DDB_DOCUMENT_KEY_BAD.code, err.errorNum);
        }
      });
    },
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testSaveDocumentDuplicate : function () {
      ...
      try {
        ...
        assertEqual(ERRORS.ERROR_DDB_UNIQUE_CONSTRAINT_VIOLATED.code, err.errorNum);
      }
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testReadDocumentConflict : function () {
      ...
      try {
        ...
        assertEqual(ERRORS.ERROR_DDB_CONFLICT.code, err.errorNum);
      }
    },
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testExistsDocument : function () {
      ...
      try {
        ...
        assertEqual(ERRORS.ERROR_DDB_CONFLICT.code, err0.errorNum);
      }
      ...
      try {
        ...
        assertEqual(ERRORS.ERROR_DDB_CROSS_COLLECTION_REQUEST.code, err1.errorNum);
      }
      ...
      try {
        ...
        assertEqual(ERRORS.ERROR_DDB_DOCUMENT_HANDLE_BAD.code, err2.errorNum);
      }
    },
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testDeleteDocument : function () {
      ...
      try {
        ...
        assertEqual(ERRORS.ERROR_DDB_DOCUMENT_NOT_FOUND.code, err2.errorNum);
      }
    },
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testDBExistsDocument : function () {
      ...
      try {
        ...
        assertEqual(ERRORS.ERROR_DDB_DATA_SOURCE_NOT_FOUND.code, err1.errorNum);
      }
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testDocumentIdThrowsIfInvalid () {
      ...
      for (const key of ["/", "", undefined, "{invalid}"]) {
        ...
        assertTrue(error);
        assertEqual(error.errorNum, ERRORS.ERROR_DDB_DOCUMENT_KEY_BAD.code);
      }
    },
