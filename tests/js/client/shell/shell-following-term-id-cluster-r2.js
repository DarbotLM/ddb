...
let db = darbotdb.db;
let { getMetric, waitForShardsInSync } = require('@darbotdb/test-helper');
  ...
  return {
    ...
    testFollowingTermIdHandlingMixedMode: function() {
      ...
      try {
        ...
        let droppedFollowersBefore = getMetric(leaderEndpoint, "darbotdb_dropped_followers_total");
        ...
        let droppedFollowersAfter = getMetric(leaderEndpoint, "darbotdb_dropped_followers_total");
    ...
    testFollowingTermIdIsSet: function() {
      ...
      try {
        ...
        droppedFollowersBefore = getMetric(leaderEndpoint, "darbotdb_dropped_followers_total");
        // the following insert should not drop any followers
        switchConnectionToCoordinator(collInfo);
        c.insert({});
        
        droppedFollowersAfter = getMetric(leaderEndpoint, "darbotdb_dropped_followers_total");
