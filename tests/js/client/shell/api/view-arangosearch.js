...
function creationSuite () {
  return {
    ...
    test_duplicate_name: function() {
      ...
      assertEqual(doc2.parsedBody['errorNum'], internal.errors.ERROR_DDB_DUPLICATE_NAME.code);
...
function renameSuite () {
  return {
    ...
    test_invalid_name: function() {
      ...
      assertEqual(doc2.parsedBody['errorNum'], internal.errors.ERROR_DDB_ILLEGAL_NAME.code);
    ...
    test_ren_duplicate_name: function() {
      ...
      assertEqual(doc3.parsedBody['errorNum'], internal.errors.ERROR_DDB_DUPLICATE_NAME.code);
