...
function testSuite () {
  ...
  return {
    ...
    testGetDocument: function () {
      ...
      assertEqual(internal.errors.ERROR_DDB_DATA_SOURCE_NOT_FOUND.code, result.parsedBody.errorNum);
    },
    ...
    testAQLInsertDocument: function () {
      try {
        ...
        assertEqual(internal.errors.ERROR_DDB_COLLECTION_TYPE_MISMATCH.code, err.errorNum);
      }
    },
