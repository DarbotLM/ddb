...
function error_handlingSuite () {
  return {
    ...
    test_creating_a_collection_without_body: function () {
      ...
      assertEqual(doc.parsedBody['errorNum'], internal.errors.ERROR_DDB_ILLEGAL_NAME.code);
    },
    ...
    test_creating_a_collection_with_a_duplicate_name: function() {
      ...
      assertEqual(doc.parsedBody['errorNum'], internal.errors.ERROR_DDB_DUPLICATE_NAME.code);
    },
