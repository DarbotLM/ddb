...
const uniqueCode = ERRORS.ERROR_DDB_UNIQUE_CONSTRAINT_VIOLATED.code;
const invalidCode = ERRORS.ERROR_DDB_DOCUMENT_TYPE_INVALID.code;
const keyBadCode = ERRORS.ERROR_DDB_DOCUMENT_KEY_BAD.code;
  ...
  describe('basics', function () {
    ...
    it('replace multi', function () {
      ...
      for (let i = 0; i < docs3.length; i++) {
        ...
        expect(docs4[i].errorNum).to.equal(ERRORS.ERROR_DDB_CONFLICT.code);
      }
    ...
    it('replace multi precondition', function () {
      ...
      for (let i = 0; i < l3.length; ++i) {
        ...
        expect(b3[i].errorNum).to.equal(ERRORS.ERROR_DDB_CONFLICT.code);
      }
