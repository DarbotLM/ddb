...
var ArangoCollection = darbotdb.ArangoCollection;
var db = darbotdb.db;
var ERRORS = darbotdb.errors;
var wait = require("internal").wait;
var testHelper = require("@darbotdb/test-helper").helper;
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testErrorHandlingBadHandle : function () {
      try {
        ...
        assertEqual(ERRORS.ERROR_DDB_INVALID_EDGE_ATTRIBUTE.code, err.errorNum);
      }
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testEdgesCollectionTypeInvalid : function () {
      ...
      try {
        ...
        assertEqual(ERRORS.ERROR_DDB_COLLECTION_TYPE_INVALID.code, err.errorNum);
      }
