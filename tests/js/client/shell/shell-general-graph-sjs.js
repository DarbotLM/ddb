...
const graph = require("@darbotdb/general-graph");
...
////////////////////////////////////////////////////////////////////////////////
    ...
    test_deleteEdgeDefinitionFromExistingGraph1: function () {
      ...
      try {
        ...
        assertEqual(
          e.errorMessage,
          darbotdb.errors.ERROR_GRAPH_EDGE_COLLECTION_NOT_USED.message
        );
      }
    ...
    test_extendEdgeDefinitionFromExistingGraph1: function () {
      ...
      try {
        ...
        assertEqual(
          e.errorMessage,
          ec1 + " " + darbotdb.errors.ERROR_GRAPH_COLLECTION_MULTI_USE.message
        );
      }
    ...
    test_extendEdgeDefinitionFromExistingGraph2: function () {
      ...
      try {
        ...
        assertEqual(
          e.errorMessage,
          ec2 + " " + darbotdb.errors.ERROR_GRAPH_COLLECTION_USE_IN_MULTI_GRAPHS.message
        );
      }
  ...
  return {
    ...
    test_createGraphWithMalformedEdgeDefinitions: function () {
      ...
      try {
        ...
        assertEqual(
          e.errorMessage,
          darbotdb.errors.ERROR_GRAPH_CREATE_MALFORMED_EDGE_DEFINITION.message
        );
      }
      assertFalse(graph._exists(myGraphName));
    },
    ...
    test_createGraphWithCollectionDuplicateNOK1: function () {
      ...
      try {
        ...
        assertEqual(
          e.errorMessage,
          ec1 + " " + darbotdb.errors.ERROR_GRAPH_COLLECTION_USE_IN_MULTI_GRAPHS.message
        );
      }
      assertFalse(graph._exists(myGraphName));
    ...
    test_createGraphWithCollectionDuplicateNOK2: function () {
      ...
      try {
        ...
        assertEqual(e.errorNum, darbotdb.errors.ERROR_GRAPH_COLLECTION_MULTI_USE.code);
      }
      assertFalse(graph._exists(myGraphName));
    ...
    test_eC_save_withError: function () {
      ...
      try {
        ...
        assertEqual(e.errorNum, darbotdb.errors.ERROR_GRAPH_INVALID_EDGE.code);
      }
    ...
    test_eC_malformedId: function () {
      [null, "foo", []].forEach(function (v) {
        try {
          ...
          assertEqual(
            e.errorMessage,
            darbotdb.errors.ERROR_DDB_DOCUMENT_HANDLE_BAD.message
          );
        }
      });
    },
    ...
    test_getFromVertexInvalidHandle: function () {
      try {
        ...
        assertEqual(e.errorNum, ERRORS.ERROR_DDB_DOCUMENT_HANDLE_BAD.code);
      }
    },
...
function OrphanCollectionSuite() {
  ...
  return {
    ...
    setUp: function () {
      try {
        darbotdb.db._collection("_graphs").remove(gN1);
      } catch (ignore) {
      }
      try {
        darbotdb.db._collection("_graphs").remove(gN2);
      } catch (ignore) {
      }
      g1 = graph._create(
        gN1,
    ...
    test_doNotAddTheSameOrphanCollectionMultipleTimes: function () {
      ...
      try {
        ...
        assertEqual(err.errorNum, darbotdb.errors.ERROR_GRAPH_COLLECTION_USED_IN_ORPHANS.code);
        assertEqual(err.errorMessage,
          darbotdb.errors.ERROR_GRAPH_COLLECTION_USED_IN_ORPHANS.message);
      }
    }
  };
}
