...
const {arango, db, ArangoError} = require("@darbotdb");
...
const {
  ...
  ERROR_DDB_COLLECTION_TYPE_INVALID,
  ERROR_CLUSTER_INSUFFICIENT_DBSERVERS,
  ERROR_HTTP_CONFLICT,
  ERROR_DDB_DUPLICATE_NAME,
  ERROR_CLUSTER_UNKNOWN_DISTRIBUTESHARDSLIKE,
  ERROR_INTERNAL,
  ERROR_DDB_ILLEGAL_NAME,
  ...
  return {
    ...
    testDuplicateName: function () {
      ...
      try {
        ...
        isDisallowed(ERROR_HTTP_CONFLICT.code, ERROR_DDB_DUPLICATE_NAME.code, resAgain, {name: collname});
      } finally {
        db._drop(collname);
      }
    },
    ...
    testCreateSystemCollectionName: function () {
      ...
      isDisallowed(ERROR_HTTP_BAD_PARAMETER.code, ERROR_DDB_ILLEGAL_NAME.code, res, {});
    },
