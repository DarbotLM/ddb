...
const ArangoError = require("@darbotdb").ArangoError;
const CI = require('@darbotdb/cluster-info');
    ...
    testCreateInvalid : function () {
      ...
      invalidNames.forEach(function (collectionName) {
        try {
          ...
          assertEqual(ERRORS.ERROR_DDB_ILLEGAL_NAME.code, err.errorNum, collectionName);
        }
      });
    },
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testRecreate : function () {
      ...
      try {
        ...
        assertEqual(ERRORS.ERROR_DDB_DUPLICATE_NAME.code, err.errorNum);
      }
...
////////////////////////////////////////////////////////////////////////////////
    ...
    // regression test for https://github.com/darbotdb/darbotdb/pull/21071
