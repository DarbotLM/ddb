...
////////////////////////////////////////////////////////////////////////////////
    ...
    testDropIndex: function() {
      ...
      try {
        ...
        assertEqual(errors.ERROR_DDB_INDEX_NOT_FOUND.code, err.errorNum);
      }
...
////////////////////////////////////////////////////////////////////////////////
    ...
    testGetIndexDropped: function() {
      ...
      try {
        ...
        assertEqual(errors.ERROR_DDB_DATA_SOURCE_NOT_FOUND.code, e1.errorNum);
      }
      ...
      try {
        ...
        assertEqual(errors.ERROR_DDB_DATA_SOURCE_NOT_FOUND.code, e2.errorNum);
      }
    },
        ...
        isUnique.forEach(isUnique => {
          invalidFields.forEach(invalidField => {
            try {
              ...
              assertEqual(errors.ERROR_DDB_ATTRIBUTE_PARSER_FAILED.code, err.errorNum);
            }
          });
        });
      });
