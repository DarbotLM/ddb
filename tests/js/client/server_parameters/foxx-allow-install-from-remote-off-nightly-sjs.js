...
const errors = require('@darbotdb').errors;
...
function testSuite() {
  ...
  return {
    testInstallViaAardvarkOk: function() {
      const urls = [
        "http://github.com/darbotdb-foxx/demo-itzpapalotl/archive/refs/heads/master.zip",
        "https://github.com/darbotdb-foxx/demo-itzpapalotl/archive/refs/heads/master.zip",
        "http://www.github.com/darbotdb-foxx/demo-itzpapalotl/archive/refs/heads/master.zip",
        "https://www.github.com/darbotdb-foxx/demo-itzpapalotl/archive/refs/heads/master.zip",
      ];
      urls.forEach((url) => {
        try {
