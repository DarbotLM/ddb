...
/// @author Copyright 2023, darbotdb GmbH, Cologne, Germany
// //////////////////////////////////////////////////////////////////////////////
...
const utils = require('@darbotdb/foxx/manager-utils');
...
const isCov = require("@darbotdb/test-helper").versionHas('coverage');
...
const installFoxxZipFile = (databaseName, usePrimary, fileName, coordinatorId, expectedFailureCode = undefined) => {
  ...
  if (expectedFailureCode) {
    ...
    // in some failure cases. Created BTS-Ticket: https://darbotdb.atlassian.net/browse/BTS-1345 needs to be resolved
    // first.
