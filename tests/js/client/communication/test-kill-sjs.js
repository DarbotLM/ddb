...
let { versionHas } = require('@darbotdb/test-helper');
...
function KillSuite () {
  ...
  return {
    ...
    testKillInParallel: function () {
      let queryCode = `
let ERRORS = require('@darbotdb').errors;
try {
...
`;
      ...
      let killCode = `
let queries = require("@darbotdb/aql/queries");
...
`;
      ...
      let killed = 0;
      let queries = require("@darbotdb/aql/queries").current().forEach(function(query) {
