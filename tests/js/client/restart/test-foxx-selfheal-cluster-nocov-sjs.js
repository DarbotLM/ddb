...
const crypto = require('@darbotdb/crypto');
...
function testSuite() {
  ...
  return {
    setUp : function() {
      ...
      arango.POST(`/_admin/execute`, "require('@darbotdb/foxx/manager').healAll(); return 1");
    ...
    tearDown : function() {
      ...
      let res = arango.POST(`/_admin/execute`, "require('@darbotdb/foxx/manager').healAll(); return 1");
      assertEqual("1", res);
