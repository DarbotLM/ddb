...
class TransactionalStore {
 public:
  ...
  struct Transaction {
    darbotdb::cache::Transaction cache;
    rocksdb::Transaction* rocks;

    Transaction(darbotdb::cache::Transaction c, rocksdb::Transaction* r);
  };
 ...
 private:
  ...
  darbotdb::basics::StringBuffer _directory;
  std::uint32_t _id;
