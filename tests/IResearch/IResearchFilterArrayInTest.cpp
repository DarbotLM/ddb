...
void checkTermFilter(FilterIterator begin, bool) {
  ...
  {
    ++begin;
    EXPECT_EQ(irs::type<darbotdb::iresearch::ByExpression>::id(),
              (*begin)->type());
    EXPECT_NE(nullptr, dynamic_cast<darbotdb::iresearch::ByExpression const*>(
                           begin->get()));
  }
  {
    ++begin;
...
TEST_F(IResearchFilterArrayInTest, BinaryIn) {
  ...
  {
    darbotdb::aql::Variable var("c", 0, /*isFullDocumentFromCollection*/ false,
                                resourceMonitor);
    darbotdb::aql::AqlValue value(darbotdb::aql::AqlValueHintInt(2));
    darbotdb::aql::AqlValueGuard guard(value, true);
  ...
  {
    auto obj = darbotdb::velocypack::Parser::fromJson("[ \"1\", 2, \"3\"]");
    darbotdb::aql::AqlValue value(obj->slice());
    darbotdb::aql::AqlValueGuard guard(value, true);
  ...
  // AT LEAST
  {
    ...
    ctxX.vars.emplace(
        "x", darbotdb::aql::AqlValue(darbotdb::aql::AqlValueHintDouble(3)));
    auto arrJson = VPackParser::fromJson(R"(["1", "2", "3", "4", "5"])");
    ctxX.vars.emplace("arr", darbotdb::aql::AqlValue(arrJson->slice()));
    ...
    ctxXstr.vars.emplace("x", darbotdb::aql::AqlValue("3"));
  ...
  // self-referenced value
  {
    ...
    for (auto caseData : testCases) {
      ...
      {
        darbotdb::iresearch::QueryContext const ctx{.ref = ref,
                                                    .isSearchQuery = true};
        darbotdb::iresearch::FieldMeta::Analyzer analyzer{
            darbotdb::iresearch::IResearchAnalyzerFeature::identity()};
        darbotdb::iresearch::FilterContext const filterCtx{
  ...
  // not array as left argument
  {
    ...
    ctx.vars.emplace("b",
                     darbotdb::aql::AqlValue(darbotdb::aql::AqlValue{"c"}));
    ctx.vars.emplace("c", darbotdb::aql::AqlValue(darbotdb::aql::AqlValue(
                              darbotdb::aql::AqlValueHintInt{4})));
    ctx.vars.emplace("e", darbotdb::aql::AqlValue(darbotdb::aql::AqlValue(
                              darbotdb::aql::AqlValueHintDouble{5.6})));
  ...
  // heterogeneous references and expression in array, analyzer, boost ANY
  {
    SCOPED_TRACE(
        ...
        "ANY");
    ExpressionContextMock ctx;
    ctx.vars.emplace("strVal", darbotdb::aql::AqlValue("str"));
    ctx.vars.emplace("boolVal", darbotdb::aql::AqlValue(
...
TEST_F(IResearchFilterArrayInTest, BinaryNotIn) {
...

        {
          ...
          // 2nd filter
          {
            ...
            EXPECT_EQ(irs::type<darbotdb::iresearch::ByExpression>::id(),
                      (*begin)->type());
            EXPECT_NE(nullptr,
                      dynamic_cast<darbotdb::iresearch::ByExpression const*>(
                          begin->get()));
          }
...
#ifdef USE_ENTERPRISE
  {
    ...
    *exists.mutable_field() = darbotdb::iresearch::DocumentPrimaryKey::PK();
    ...
    assertFilterSuccess(vocbase(),
                        ...
                        darbotdb::iresearch::FilterOptimization::NONE, true,
                        true, true);
    assertFilterSuccess(vocbase(),
                        "FOR d IN collection FILTER BOOST([] NONE IN "
                        "d.quick.brown.fox, 2.5) RETURN d",
    ...
    assertFilterSuccess(
        ...
        "FOR d IN collection FILTER BOOST([] AT LEAST(0) IN d.a, 2.5) RETURN d",
        expected, nullptr, nullptr, "d",
        darbotdb::iresearch::FilterOptimization::NONE, true, true, true);
  ...
  }
  {
    ...
    *all.mutable_field() = darbotdb::iresearch::DocumentPrimaryKey::PK();
