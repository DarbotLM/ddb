...
void serializationChecker(ArangodServer& server,
  ...
  darbotdb::iresearch::IResearchInvertedIndexMeta metaLhs, metaRhs;
...
class IResearchInvertedIndexMetaTest
    : public ::testing::Test,
      public tests::LogSuppressor<darbotdb::Logger::AGENCYCOMM,
                                  LogLevel::FATAL>,
      public tests::LogSuppressor<darbotdb::Logger::AUTHENTICATION,
                                  LogLevel::ERR> {
 protected:
...
TEST_F(IResearchInvertedIndexMetaTest, testIgnoreAnalyzerDefinitions) {
  ...
  darbotdb::iresearch::IResearchInvertedIndexMeta metaLhs;
  ...
  darbotdb::iresearch::IResearchInvertedIndexMeta metaRhs;
...
TEST_F(IResearchInvertedIndexMetaTest, testDefaults) {
  ...
  ASSERT_EQ(meta._features, darbotdb::iresearch::Features());
...
TEST_F(IResearchInvertedIndexMetaTest, testReadDefaults) {
  ...
  // without active vocbase
  {
    ...
    ASSERT_EQ(meta._features,
              darbotdb::iresearch::Features(FieldFeatures::NORM,
