...
TEST_F(IResearchFilterInTest, BinaryIn) {
  ...
  // false expression
  {
    ...
    assertFilterSuccess(
        ...
        &ExpressionContextMock::EMPTY);  // by some reason darbotdb evaluates it
                                         // to false
  }
  ...
  // range as reference
  {
    darbotdb::aql::AqlValue value(1, 3);
    darbotdb::aql::AqlValueGuard guard(value, true);
    ...
    ExpressionContextMock ctx;
    ctx.vars.emplace("x", darbotdb::aql::AqlValue(1, 3));
  ...
  // false expression
  {
    ...
    assertFilterSuccess(vocbase(),
                        ...
                        &ExpressionContextMock::EMPTY);  // darbotdb feature
  }
