  ...
  void create() {
    // create collection0
    {
      ...
      std::vector<std::shared_ptr<darbotdb::velocypack::Builder>> docs{
          darbotdb::velocypack::Parser::fromJson("{ \"seq\": -7 }"),
          darbotdb::velocypack::Parser::fromJson(
              "{ \"seq\": -6, \"value\": null}"),
          darbotdb::velocypack::Parser::fromJson(
              "{ \"seq\": -5, \"value\": null}"),
          darbotdb::velocypack::Parser::fromJson("{ \"seq\": -4 }"),
          darbotdb::velocypack::Parser::fromJson(
              "{ \"seq\": -3, \"value\": null}"),
          darbotdb::velocypack::Parser::fromJson(
              "{ \"seq\": -2, \"value\": null}"),
          darbotdb::velocypack::Parser::fromJson("{ \"seq\": -1 }"),
          darbotdb::velocypack::Parser::fromJson(
              "{ \"seq\": 0, \"value\": null }"),
          darbotdb::velocypack::Parser::fromJson("{ \"seq\": 1 }")};
    ...
    // create collection1
    {
      ...
      std::vector<std::shared_ptr<darbotdb::velocypack::Builder>> docs{
          darbotdb::velocypack::Parser::fromJson(
              "{ \"seq\": 2, \"value\": null}"),
          darbotdb::velocypack::Parser::fromJson("{ \"seq\": 3 }"),
          darbotdb::velocypack::Parser::fromJson("{ \"seq\": 4 }"),
          darbotdb::velocypack::Parser::fromJson("{ \"seq\": 5 }"),
          darbotdb::velocypack::Parser::fromJson(
              "{ \"seq\": 6, \"value\": null}"),
          darbotdb::velocypack::Parser::fromJson(
              "{ \"seq\": 7, \"value\": null}"),
          darbotdb::velocypack::Parser::fromJson("{ \"seq\": 8 }")};
  ...
  void queryTests() {
    ...
    // d.value == null, unordered
    {
      ...
      for (auto const& doc : _insertedDocs) {
        darbotdb::velocypack::Slice docSlice = doc.slice().resolveExternals();
    ...
    {
      std::map<ptrdiff_t, darbotdb::velocypack::Slice> expectedDocs;
      for (auto const& doc : _insertedDocs) {
        darbotdb::velocypack::Slice docSlice = doc.slice().resolveExternals();
        auto const valueSlice = docSlice.get("value");
    ...
    // invalid type
    {
      ...
      for (auto const& doc : _insertedDocs) {
        ...
        if (!fieldSlice.isNone() &&
            "null" == darbotdb::iresearch::getStringRef(fieldSlice)) {
          continue;
        }
    ...
    {
      std::unordered_map<size_t, darbotdb::velocypack::Slice> expectedDocs{
