...
inline auto GetLinkVersions() noexcept {
  return testing::Values(darbotdb::iresearch::LinkVersion::MIN,
                         darbotdb::iresearch::LinkVersion::MAX);
}

inline auto GetIndexVersions() noexcept {
  return testing::Values(darbotdb::iresearch::LinkVersion::MAX);
}

class IResearchQueryTest
    : public ::testing::TestWithParam<darbotdb::iresearch::LinkVersion>,
 ...
 protected:
  ...
  virtual darbotdb::ViewType type() const {
    return darbotdb::ViewType::kArangoSearch;
  }
