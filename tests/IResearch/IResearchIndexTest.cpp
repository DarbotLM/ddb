...
class TestAnalyzer final : public irs::analysis::TypedAnalyzer<TestAnalyzer> {
 public:
  ...
  TestAnalyzer(std::string_view value) {
    auto slice = darbotdb::iresearch::slice(value);
...
class IResearchIndexTest
    : public ::testing::Test,
      ...
      public darbotdb::tests::LogSuppressor<darbotdb::Logger::AQL,
                                            darbotdb::LogLevel::ERR> {
 protected:
 ...
 protected:
  IResearchIndexTest() : server(false) {
    ...
    analyzers.emplace(
        ...
        darbotdb::velocypack::Parser::fromJson("{ \"args\": \"X\" }")->slice(),
        darbotdb::transaction::OperationOriginTestCase{});
    analyzers.emplace(
        result, "testVocbase::test_B", "TestInsertAnalyzer",
        darbotdb::velocypack::Parser::fromJson("{ \"args\": \"Y\" }")->slice(),
        darbotdb::transaction::OperationOriginTestCase{});
...
TEST_F(IResearchIndexTest, test_analyzer) {
  auto createCollection0 = darbotdb::velocypack::Parser::fromJson(
      "{ \"name\": \"testCollection0\" }");
  auto createCollection1 = darbotdb::velocypack::Parser::fromJson(
      "{ \"name\": \"testCollection1\" }");
  auto createView = darbotdb::velocypack::Parser::fromJson(
  ...
  // link collections with view
  {
    ...
    auto nestedIndex = darbotdb::velocypack::Parser::fromJson(
    ...
    //    ASSERT_TRUE(darbotdb::methods::Indexes::ensureIndex(collection,
  ...
  // populate collections asynchronously
  {
    std::thread thread0([collection0, &resThread0]() -> void {
      ...
      try {
        ...
        builder = darbotdb::basics::VelocyPackHelper::velocyPackFromFile(
            resource.string());
      } catch (...) {
      ...
      darbotdb::SingleCollectionTransaction trx(
          darbotdb::transaction::StandaloneContext::create(
              collection0->vocbase(),
              darbotdb::transaction::OperationOriginTestCase{}),
          *collection0, darbotdb::AccessMode::Type::WRITE);
    ...
    std::thread thread1([collection1, &resThread1]() -> void {
      ...
      darbotdb::SingleCollectionTransaction trx(
          darbotdb::transaction::StandaloneContext::create(
              collection1->vocbase(),
              darbotdb::transaction::OperationOriginTestCase{}),
          *collection1, darbotdb::AccessMode::Type::WRITE);
...
TEST_F(IResearchIndexTest, test_pkCachedInverted) {
  ...
  // link collections with view
  {
    auto updateJson = darbotdb::velocypack::Parser::fromJson(R"({
      "name": "inverted",
      "type": "inverted",
      "primaryKeyCache": true,
      "fields":  ["X", "Y"]})");
