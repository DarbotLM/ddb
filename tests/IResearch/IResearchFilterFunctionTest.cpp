...
TEST_F(IResearchFilterFunctionTest, AttributeAccess) {
  // attribute access, non empty object
  {
    ...
    ctx.vars.emplace("x", darbotdb::aql::AqlValue(obj->slice()));
...
TEST_F(IResearchFilterFunctionTest, ValueReference) {
  ...
  // string reference
  {
    ExpressionContextMock ctx;
    ctx.vars.emplace("x",
                     darbotdb::aql::AqlValue(darbotdb::aql::AqlValue("abc")));
  ...
  {
    ExpressionContextMock ctx;
    ctx.vars.emplace("x", darbotdb::aql::AqlValue(darbotdb::aql::AqlValue("")));
  ...
  // boolean reference
  {
    ExpressionContextMock ctx;
    ctx.vars.emplace("x", darbotdb::aql::AqlValue(darbotdb::aql::AqlValue(
                              darbotdb::aql::AqlValueHintBool{true})));
  ...
  // boolean reference
  {
    ExpressionContextMock ctx;
    ctx.vars.emplace("x", darbotdb::aql::AqlValue(darbotdb::aql::AqlValue(
                              darbotdb::aql::AqlValueHintBool{false})));
  ...
  // non zero numeric reference
  {
    ExpressionContextMock ctx;
    ctx.vars.emplace("x", darbotdb::aql::AqlValue(darbotdb::aql::AqlValue(
                              darbotdb::aql::AqlValueHintInt{1})));
  ...
  // zero numeric reference
  {
    ExpressionContextMock ctx;
    ctx.vars.emplace("x", darbotdb::aql::AqlValue(darbotdb::aql::AqlValue(
                              darbotdb::aql::AqlValueHintInt{0})));
  ...
  // zero floating reference
  {
    ExpressionContextMock ctx;
    ctx.vars.emplace("x", darbotdb::aql::AqlValue(darbotdb::aql::AqlValue(
                              darbotdb::aql::AqlValueHintDouble{0.0})));
  ...
  // non zero floating reference
  {
    ExpressionContextMock ctx;
    ctx.vars.emplace("x", darbotdb::aql::AqlValue(darbotdb::aql::AqlValue(
                              darbotdb::aql::AqlValueHintDouble{0.1})));
  ...
  // Array reference
  {
    ...
    ExpressionContextMock ctx;
    ctx.vars.emplace(
        "x", darbotdb::aql::AqlValue(darbotdb::aql::AqlValue(obj->slice())));
  ...
  // Range reference
  {
    ExpressionContextMock ctx;
    ctx.vars.emplace("x",
                     darbotdb::aql::AqlValue(darbotdb::aql::AqlValue(1, 1)));
  ...
  // numeric expression
  {
    ExpressionContextMock ctx;
    ctx.vars.emplace(
        "numVal", darbotdb::aql::AqlValue(darbotdb::aql::AqlValueHintInt(2)));
  ...
  // null expression
  {
    ExpressionContextMock ctx;
    ctx.vars.emplace(
        "nullVal", darbotdb::aql::AqlValue(darbotdb::aql::AqlValueHintNull{}));
...
TEST_F(IResearchFilterFunctionTest, Boost) {
  // simple boost
  {
    ExpressionContextMock ctx;
    ctx.vars.emplace("x", darbotdb::aql::AqlValue(darbotdb::aql::AqlValue(
                              darbotdb::aql::AqlValueHintDouble{1.5})));
...
TEST_F(IResearchFilterFunctionTest, Analyzer) {
  ...
  // expression as the parameter
  {
    ExpressionContextMock ctx;
    ctx.vars.emplace("x",
                     darbotdb::aql::AqlValue(darbotdb::aql::AqlValue("test_")));
...
TEST_F(IResearchFilterFunctionTest, MinMatch) {
  // simplest MIN_MATCH
  {
    ExpressionContextMock ctx;
    ctx.vars.emplace("x", darbotdb::aql::AqlValue(darbotdb::aql::AqlValue(
                              darbotdb::aql::AqlValueHintInt{2})));
...
TEST_F(IResearchFilterFunctionTest, Exists) {
  // field only
  {
    ...
    *exists.mutable_field() = "name";
    exists.mutable_options()->acceptor =
        darbotdb::iresearch::makeColumnAcceptor(false);
  ...
  // complex field with offset
  {
    ExpressionContextMock ctx;
    ctx.vars.emplace(
        "index", darbotdb::aql::AqlValue(darbotdb::aql::AqlValueHintInt(2)));
  ...
  // dynamic complex attribute field
  {
    ExpressionContextMock ctx;
    ctx.vars.emplace("a",
                     darbotdb::aql::AqlValue(darbotdb::aql::AqlValue{"a"}));
    ctx.vars.emplace("c",
                     darbotdb::aql::AqlValue(darbotdb::aql::AqlValue{"c"}));
    ctx.vars.emplace("offsetInt",
                     darbotdb::aql::AqlValue(darbotdb::aql::AqlValue(
                         darbotdb::aql::AqlValueHintInt{4})));
    ctx.vars.emplace("offsetDbl",
                     darbotdb::aql::AqlValue(darbotdb::aql::AqlValue(
                         darbotdb::aql::AqlValueHintDouble{5.6})));
  ...
  // invalid dynamic attribute name (null value)
  {
    ExpressionContextMock ctx;
    ctx.vars.emplace(
        "a", darbotdb::aql::AqlValue(
                 darbotdb::aql::AqlValueHintNull{}));  // invalid value type
    ctx.vars.emplace("c",
                     darbotdb::aql::AqlValue(darbotdb::aql::AqlValue{"c"}));
    ctx.vars.emplace("offsetInt",
                     darbotdb::aql::AqlValue(darbotdb::aql::AqlValue(
  ...
  // invalid dynamic attribute name (bool value)
  {
    ExpressionContextMock ctx;
    ctx.vars.emplace("a",
                     darbotdb::aql::AqlValue(darbotdb::aql::AqlValueHintBool{
  ...
  {
    ExpressionContextMock ctx;
    ctx.vars.emplace("anl", darbotdb::aql::AqlValue("str"));
  ...
  // field + analyzer as invalid expression
  {
    ExpressionContextMock ctx;
    ctx.vars.emplace(
        "anl", darbotdb::aql::AqlValue(darbotdb::aql::AqlValueHintNull{}));
  ...
  {
    ExpressionContextMock ctx;
    ctx.vars.emplace("type", darbotdb::aql::AqlValue("analy"));
  ...
  {
    ExpressionContextMock ctx;
    ctx.vars.emplace("type", darbotdb::aql::AqlValue("nume"));
  ...
  {
    ExpressionContextMock ctx;
    ctx.vars.emplace("type", darbotdb::aql::AqlValue("boo"));
  ...
  {
    ExpressionContextMock ctx;
    ctx.vars.emplace("type", darbotdb::aql::AqlValue("nu"));
  ...
  // field + type + invalid expression
  {
    ExpressionContextMock ctx;
    ctx.vars.emplace(
        "type", darbotdb::aql::AqlValue(darbotdb::aql::AqlValueHintNull{}));
  ...
  {
    ExpressionContextMock ctx;
    ctx.vars.emplace("anl", darbotdb::aql::AqlValue("test_"));
    ctx.vars.emplace("type", darbotdb::aql::AqlValue("analyz"));
...
TEST_F(IResearchFilterFunctionTest, Phrase) {
  ...
  {
    ExpressionContextMock ctx;
    ctx.vars.emplace("value", darbotdb::aql::AqlValue("qui"));
    ctx.vars.emplace("analyzer", darbotdb::aql::AqlValue("test_"));
  ...
  // quick
  {
    ExpressionContextMock ctx;
    ctx.vars.emplace("value", darbotdb::aql::AqlValue("qui"));
    ctx.vars.emplace("analyzer", darbotdb::aql::AqlValue(
                                     darbotdb::aql::AqlValueHintBool{false}));
  ...
  // quick <...> <...> <...> brown <...> <...> fox jumps
  {
    ...
    *phrase.mutable_field() =
    ...
    ExpressionContextMock ctx;
    ctx.vars.emplace(
        "offset", darbotdb::aql::AqlValue(darbotdb::aql::AqlValueHintInt(2)));
    ctx.vars.emplace("input", darbotdb::aql::AqlValue("bro"));
...

  {
    ...
    *phrase.mutable_field() =
        ...
        irs::ViewCast<irs::byte_type>(std::string_view("n"));
    {
      ...
      part.provider = &darbotdb::iresearch::getParametricDescription;
    ...
    ctx.vars.emplace(
        "offset", darbotdb::aql::AqlValue(darbotdb::aql::AqlValueHintInt(2)));
    ctx.vars.emplace("input_st", darbotdb::aql::AqlValue("q"));
    ctx.vars.emplace("input_pt", darbotdb::aql::AqlValue("c"));
    ctx.vars.emplace("input_wt", darbotdb::aql::AqlValue("b"));
    ctx.vars.emplace("input_lt", darbotdb::aql::AqlValue("p"));
    ctx.vars.emplace("input_ct", darbotdb::aql::AqlValue("g"));
    ctx.vars.emplace("input_ct2", darbotdb::aql::AqlValue("b"));
    ctx.vars.emplace("input_rt", darbotdb::aql::AqlValue("n"));
...
TEST_F(IResearchFilterFunctionTest, StartsWith) {
  ...
  // without scoring limit via []
  {
    ...
    orFilter.min_match_count(
        darbotdb::iresearch::FilterConstants::DefaultStartsWithMinMatchCount);
  ...
  {
    ExpressionContextMock ctx;
    ctx.vars.emplace("prefix", darbotdb::aql::AqlValue("ab"));
  ...
  {
    ExpressionContextMock ctx;
    ctx.vars.emplace("prefix", darbotdb::aql::AqlValue(
                                   darbotdb::aql::AqlValueHintBool(false)));
  ...
  // expression
  {
    ExpressionContextMock ctx;
    ctx.vars.emplace("prefix", darbotdb::aql::AqlValue("ab"));
    ctx.vars.emplace("scoringLimit", darbotdb::aql::AqlValue(
                                         darbotdb::aql::AqlValueHintInt(5)));
  ...
  // expression, analyzer
  {
    ExpressionContextMock ctx;
    ctx.vars.emplace("prefix", darbotdb::aql::AqlValue("ab"));
    ctx.vars.emplace("analyzer", darbotdb::aql::AqlValue("analyzer"));
    ctx.vars.emplace("scoringLimit", darbotdb::aql::AqlValue(
                                         darbotdb::aql::AqlValueHintInt(5)));
  ...
  // expression of invalid type
  {
    ExpressionContextMock ctx;
    ctx.vars.emplace("prefix", darbotdb::aql::AqlValue("ab"));
    ctx.vars.emplace("scoringLimit", darbotdb::aql::AqlValue("ab"));
  ...
  {
    ExpressionContextMock ctx;
    ctx.vars.emplace("minMatchCount", darbotdb::aql::AqlValue(
                                          darbotdb::aql::AqlValueHintInt(5)));
...
TEST_F(IResearchFilterFunctionTest, wildcard) {
  ...
  // ANALYZER(d.name.foo LIKE 'foo%', 'test_analyzer')
  {
    ...
    *wildcard.mutable_field() = mangleString("name.foo", "test_analyzer");
    ...
    ExpressionContextMock ctx;
    ctx.vars.emplace("x",
                     darbotdb::aql::AqlValue(darbotdb::aql::AqlValue{"foo"}));
  ...
  // BOOST(ANALYZER(d.name[4] LIKE '_foo%', 'test_analyzer'), 0.5)
  {
    ...
    *wildcard.mutable_field() = mangleString("name[4]", "test_analyzer");
    ...
    ExpressionContextMock ctx;
    ctx.vars.emplace(
        "x", darbotdb::aql::AqlValue(darbotdb::aql::AqlValueHintInt{4}));
...
TEST_F(IResearchFilterFunctionTest, levenshteinMatch) {
  // LEVENSHTEIN_MATCH(d.name, 'foo', 1)
  {
    ...
    *filter.mutable_field() = mangleStringIdentity("name");
    ...
    opts->max_terms =
        darbotdb::iresearch::FilterConstants::DefaultLevenshteinTermsLimit;
  ...
  // ANALYZER(LEVENSHTEIN_MATCH(d.name.foo, 'foo', 0, true), 'test_analyzer')
  {
    ...
    *filter.mutable_field() = mangleString("name.foo", "test_analyzer");
    ...
    ctx.vars.emplace("x",
                     darbotdb::aql::AqlValue(darbotdb::aql::AqlValue{"foo"}));
    ctx.vars.emplace("y",
                     darbotdb::aql::AqlValue(darbotdb::aql::AqlValue{"o"}));
    ctx.vars.emplace(
        "dist", darbotdb::aql::AqlValue(darbotdb::aql::AqlValueHintInt{1}));
    ctx.vars.emplace("transp", darbotdb::aql::AqlValue(
                                   darbotdb::aql::AqlValueHintBool{true}));
                   ...
                   &ExpressionContextMock::EMPTY);
  {
    ExpressionContextMock ctx;
    ctx.vars.emplace(
        "x", darbotdb::aql::AqlValue(darbotdb::aql::AqlValueHintInt{-1}));
...
TEST_F(IResearchFilterFunctionTest, ngramMatch) {
  ...
  {
    ExpressionContextMock ctx;
    ctx.vars.emplace("strVal", darbotdb::aql::AqlValue("foo"));
  ...
  {
    ExpressionContextMock ctx;
    ctx.vars.emplace("numVal", darbotdb::aql::AqlValue(
                                   darbotdb::aql::AqlValueHintDouble(0.8)));
  ...
  // variables + function calls
  {
    ...
    *filter.mutable_field() = mangleString("name.foo", "test_analyzer");
    ...
    ExpressionContextMock ctx;
    ctx.vars.emplace(
        "x", darbotdb::aql::AqlValue(darbotdb::aql::AqlValueHintDouble{0.5}));
    ctx.vars.emplace("y",
                     darbotdb::aql::AqlValue(darbotdb::aql::AqlValue{"o"}));
    ctx.vars.emplace("idx", darbotdb::aql::AqlValue("foo"));
