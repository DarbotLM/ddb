...
bool DeleteCollection(darbotdb::httpclient::SimpleHttpClient* client,
                      std::string const& name) {
  std::unordered_map<std::string, std::string> headerFields;
  std::unique_ptr<darbotdb::httpclient::SimpleHttpResult> result(
...
bool CreateCollection(darbotdb::httpclient::SimpleHttpClient* client,
...
bool CreateIndex(darbotdb::httpclient::SimpleHttpClient* client,
...
bool CreateDocument(darbotdb::httpclient::SimpleHttpClient* client,
