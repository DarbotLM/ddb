...
struct PersistentIndexTest : public Benchmark<PersistentIndexTest> {
  static std::string name() { return "persistent-index"; }

  PersistentIndexTest(BenchFeature& arangobench)
      : Benchmark<PersistentIndexTest>(arangobench) {}

  bool setUp(darbotdb::httpclient::SimpleHttpClient* client) override {
    bool result = true;
