...
struct BenchmarkOperation {
  struct RequestData {
    ...
    std::string url;
    darbotdb::rest::RequestType type;
    darbotdb::velocypack::Options options;
    darbotdb::velocypack::Builder payload;

    void clear() {
      url.clear();
      payload.clear();
      type = darbotdb::rest::RequestType::ILLEGAL;
    }
  };
  ...
  virtual bool setUp(darbotdb::httpclient::SimpleHttpClient*) = 0;
 ...
 protected:
  darbotdb::BenchFeature& _arangobench;
};
