# darbotdb Clang-Format

darbotdb uses `clang-format` to lint the codebase of [darbotdb/darbotdb](https://github.com/darbotdb/darbotdb) & [darbotdb/enterprise](https://github.com/darbotdb/enterprise).
...
Once your changes are pushed, a [GitHub Action CI](https://github.com/darbotdb/clang-format-action) will be triggered to validate that your changes comply to the [established clang-format standard](https://github.com/darbotdb/darbotdb/blob/devel/.clang-format). Should you be missing any format specifications, your push’s CI will fail.


# darbotdb coding guidelines
...
darbotdb specific adjustments.

## Preamble

These coding guidelines represent the C++ code style that we want to follow at darbotdb.
As the darbotdb code base has evolved over a period of around 10 years, there still exists
...
[non-enterprise](#non-enterprise-template) template for public darbotdb
...
/// DISCLAIMER
///
/// Copyright 2014-2021 darbotdb GmbH, Cologne, Germany
...
/// DISCLAIMER
///
/// Copyright 2021 darbotdb GmbH, Cologne, Germany
///
/// The Programs (which include both the software and documentation) contain
/// proprietary information of darbotdb GmbH; they are provided under a license
...
/// and darbotdb GmbH disclaims liability for any damages caused by such use of
/// the Programs.
///
/// This software is the confidential and proprietary information of darbotdb
/// GmbH. You shall not disclose such confidential and proprietary information
/// and shall use it only in accordance with the terms of the license agreement
/// you entered into with darbotdb GmbH.
///
/// Copyright holder is darbotdb GmbH, Cologne, Germany
///
