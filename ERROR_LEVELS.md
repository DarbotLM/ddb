...
in darbotdb's log messages. The error levels are, from most to least severe:
...
Information which is helpful to darbotdb developers as well as to other
...
darbotdb developers to debug problems in the source code.
