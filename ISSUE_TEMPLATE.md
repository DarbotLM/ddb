...
* __Operating System__:        <!-- Ubuntu 20.04 | Windows 10 | MacOS (Intel/Apple Silicon) | ... -->
* __Architecture__:        <!-- x86_64 | ARM64 | ... -->
...
* __Used Package__:              <!-- Docker | Debian/Ubuntu .deb | SUSE/RedHat .rpm | source build | other -->
...
__Dataset__:
<!-- description, or if possible, share an example dataset to reproduce the issue either as Gist with an dbdump, or an arangosh script with db.collection.save({my: "values"}) statements -->
