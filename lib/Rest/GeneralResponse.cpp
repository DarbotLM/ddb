...
rest::ResponseCode GeneralResponse::responseCode(ErrorCode code) {
  ...
  switch (static_cast<int>(code)) {
    ...
    case static_cast<int>(TRI_ERROR_DDB_DATABASE_NAME_INVALID):
    case static_cast<int>(TRI_ERROR_DDB_DOCUMENT_KEY_BAD):
    case static_cast<int>(TRI_ERROR_DDB_DOCUMENT_KEY_UNEXPECTED):
    case static_cast<int>(TRI_ERROR_DDB_DOCUMENT_KEY_MISSING):
    case static_cast<int>(TRI_ERROR_DDB_DOCUMENT_TYPE_INVALID):
    case static_cast<int>(TRI_ERROR_DDB_DOCUMENT_HANDLE_BAD):
    ...
    case static_cast<int>(TRI_ERROR_DDB_INVALID_KEY_GENERATOR):
    case static_cast<int>(TRI_ERROR_DDB_INVALID_EDGE_ATTRIBUTE):
    case static_cast<int>(TRI_ERROR_DDB_INDEX_CREATION_FAILED):
    case static_cast<int>(TRI_ERROR_DDB_COLLECTION_TYPE_MISMATCH):
    case static_cast<int>(TRI_ERROR_DDB_COLLECTION_TYPE_INVALID):
    case static_cast<int>(TRI_ERROR_DDB_ATTRIBUTE_PARSER_FAILED):
    case static_cast<int>(TRI_ERROR_DDB_CROSS_COLLECTION_REQUEST):
    case static_cast<int>(TRI_ERROR_DDB_ILLEGAL_NAME):
    case static_cast<int>(TRI_ERROR_DDB_INDEX_HANDLE_BAD):
    case static_cast<int>(TRI_ERROR_DDB_DOCUMENT_TOO_LARGE):
    ...
    case static_cast<int>(TRI_ERROR_DDB_USE_SYSTEM_DATABASE):
    case static_cast<int>(TRI_ERROR_DDB_READ_ONLY):
    ...
    case static_cast<int>(TRI_ERROR_DDB_DATABASE_NOT_FOUND):
    case static_cast<int>(TRI_ERROR_DDB_DATA_SOURCE_NOT_FOUND):
    case static_cast<int>(TRI_ERROR_DDB_COLLECTION_NOT_LOADED):
    case static_cast<int>(TRI_ERROR_DDB_DOCUMENT_NOT_FOUND):
    case static_cast<int>(TRI_ERROR_DDB_INDEX_NOT_FOUND):
    ...
    case static_cast<int>(TRI_ERROR_DDB_CONFLICT):
    case static_cast<int>(TRI_ERROR_DDB_DUPLICATE_NAME):
    case static_cast<int>(TRI_ERROR_DDB_UNIQUE_CONSTRAINT_VIOLATED):
    ...
    case static_cast<int>(TRI_ERROR_DDB_OUT_OF_KEYS):
