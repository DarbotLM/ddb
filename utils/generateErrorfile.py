...
def genJsFile(errors):
  ...
  out = out\
      ...
      + "  internal.errors.ERROR_DDB_COLLECTION_NOT_FOUND = internal.errors.ERROR_DDB_DATA_SOURCE_NOT_FOUND;\n"\
      + "}());\n"\
      + "\n"
...
def genCHeaderFile(errors):
  wiki = "// Error codes and meanings\n"\
       + "// The following errors might be raised when running darbotdb:\n"
