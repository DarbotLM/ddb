...
class DumpRestoreHelper extends trs.runLocalInArangoshRunner {
  ...
  bindInstanceInfo(options) {
    ...
    this.setOptions();
    this.arangorestore = ct.run.dbdumpRestoreWithConfig.bind(this, this.restoreConfig, this.restoreOptions, this.instanceManager.rootDir, this.firstRunOptions.coreCheck);
    this.arangorestoreOld = ct.run.dbdumpRestoreWithConfig.bind(this, this.restoreOldConfig, this.restoreOptions, this.instanceManager.rootDir, this.firstRunOptions.coreCheck);
    this.dbdump = ct.run.dbdumpRestoreWithConfig.bind(this, this.dumpConfig, this.dumpOptions, this.instanceManager.rootDir, this.firstRunOptions.coreCheck);
