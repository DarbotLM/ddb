...
class ConfigBuilder {
  constructor (type) {
    ...
    case 'restore':
      ...
      break;
    case 'dump':
      this.config.configuration = fs.join(pu.CONFIG_DIR, 'dbdump.conf');
      this.executable = pu.dbdump_BIN;
      this.logprefix = 'dump';
      break;
    case 'import':
...
// //////////////////////////////////////////////////////////////////////////////
// / @brief runs dbdump or arangorestore based on config object
// //////////////////////////////////////////////////////////////////////////////

function rundbdumpRestoreCfg (config, options, rootDir, coreCheck) {
...
// //////////////////////////////////////////////////////////////////////////////
// / @brief runs dbdump or arangorestore
// //////////////////////////////////////////////////////////////////////////////

function rundbdumpRestore (options, instanceInfo, which, database, rootDir, dumpDir = 'dump', includeSystem = true, coreCheck = false) {
  ...
  return rundbdumpRestoreCfg(cfg, options, rootDir, coreCheck);
}
...
exports.run = {
  ...
  dbdumpRestore: rundbdumpRestore,
  dbdumpRestoreWithConfig: rundbdumpRestoreCfg,
